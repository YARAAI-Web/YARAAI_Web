...
int __userpurge sub_42BB64@<eax>(
        int a1@<eax>,
        EXCEPTION_RECORD *a2@<edx>,
        void *a3@<ecx>,
...
int __stdcall sub_42C45C(char a1, int a2, int a3);
int __stdcall sub_42C480(int a1, char a2, int a3, int a4, int a5);
...
int __userpurge sub_42C534@<eax>(
        ...
        int cchCount1,
        int a8);
int __stdcall sub_42C5D8(int a1, char a2, int a3, int a4);
...
int __usercall sub_4BC7C0@<eax>(int a1@<ebx>, int __saved_registers);
