#include "ef1acfd1-5dc3-4cf6-b1e6-2af40f87a05b.h"
...
__int64 __fastcall WarningDlgProc(HWND hWnd, int a2, INT_PTR a3, UINT a4)
{
  ...
  else
  {
    ...
    SetDlgItemTextA(hWnd, 2111, Buffer);
...
__int64 __fastcall AnalyzeCmd(STRSAFE_LPSTR pszDest, __int64 a2, char **a3, _DWORD *a4)
{
  ...
  char v60; // [rsp+151h] [rbp+51h] BYREF
  ...
  *v12 = 0;
  ...
  lpAppName[0] = v14;
  Field = ExtractField((char **)lpAppName, v13);
  v16 = lpAppName[0];
  v17 = -1;
  v18 = Field;
  if ( !lpAppName[0] )
...
LABEL_25:
    ...
    if ( v26 )
      v29 = v27;
    *v29 = 0;
    AddPath(FileName, 0x104u, v16);
  }
  v30 = ANSIStrRChr(v16, 46);
  if ( v30 && CompareStringA(0x7Fu, 1u, v30, -1, ".INF", -1) == 2 )
  {
    ...
    if ( FileAttributesA == -1 || (FileAttributesA & 0x10) != 0 )
    {
      ...
      v41 = 1317;
LABEL_54:
      MsgBox2Param(0, v41, (__int64)v40, 0, 0x10u, 0);
      return 0;
    }
    lpAppName[0] = v18;
    v32 = ExtractField((char **)lpAppName, "[");
    if ( v32 )
    {
      v33 = lpAppName[0];
      if ( *v32 )
    ...
    if ( v34 )
    {
      ...
      if ( *lpAppName[0] )
        v37 = lpAppName[0];
      PrivateProfileIntA = GetPrivateProfileIntA(v37, "Reboot", 0, FileName);
      *a4 = 1;
      g_uInfRebootOn = PrivateProfileIntA;
      if ( GetPrivateProfileStringA("Version", "AdvancedINF", pszCabPath, v34, 8u, FileName) )
      {
        dword_14000DE64 |= 4u;
        if ( *v35 )
          v36 = v35;
        StringCchCopyA(pszDest, 0x104u, v36);
        StringCchCopyA(v34, 0x200u, FileName);
      }
      else
      {
        dword_14000DE64 &= ~4u;
  ...
  v43 = ANSIStrRChr(v16, 46);
  if ( !v43 || CompareStringA(0x7Fu, 1u, v43, -1, ".BAT", -1) != 2 )
  {
    v47 = 1024;
    v34 = (char *)LocalAlloc(0x40u, 0x400u);
    if ( v34 )
    {
      v48 = GetFileAttributesA(FileName);
      if ( v48 == -1 || (v48 & 0x10) != 0 )
      {
        v53 = pszDest - pszDesta;
        v54 = pszDesta;
        do
        {
          if ( v47 == -2147482622 )
      ...
      *v34 = 0;
      ExpandCmdParams(pszDesta, (unsigned __int64)v34, v34);
      goto LABEL_83;
    }
    goto LABEL_61;
  }
  ...
  do
    ++v44;
  while ( aCommandComCS[v44] );
  do
    ++v17;
  while ( FileName[v17] );
  v45 = v44 + v17;
  v46 = (char *)LocalAlloc(0x40u, v44 + v17 + 8);
  v34 = v46;
  if ( !v46 )
  {
LABEL_61:
  ...
  StringCchPrintfA(v46, v45 + 8, "Command.com /c %s", FileName);
LABEL_83:
  *a3 = v34;
  return 1;
}
...
__int64 MyNTReboot()
{
  ...
  {
    MsgBox2Param(0, 0x4F5u, 0, 0, 0x10u, 0);
    return 0;
  }
...
__int64 __fastcall DiskSpaceErrMsg(int a1, int a2, int a3, __int64 a4)
{
  ...
  switch ( a1 )
  {
    case 1:
      ...
      MsgBox2Param(0, 0x4FAu, (__int64)pszDest, 0, 0x10u, 0);
      break;
    case 4:
      StringCchPrintfA(pszDest, 0xAu, "%lu", a3 + a2);
      LOBYTE(v4) = (unsigned int)MsgBox2Param(0, 0x4BDu, (__int64)pszDest, 0, 0x20u, 5) == 4;
      break;
    case 2:
      StringCchPrintfA(pszDest, 0xAu, "%lu", a3);
      if ( (unsigned int)MsgBox2Param(0, 0x4CCu, (__int64)pszDest, a4, 0x40u, 260) == 6 )
      {
        g_dwExitCode = 0;
        return 1;
      }
...
LABEL_18:
  ...
  GetSystemDirectoryA(pszDest, 0x104u);
LABEL_22:
  if ( !v3 )
    goto LABEL_23;
  return 1;
...
int __stdcall WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nShowCmd)
{
  ...
  g_dwExitCode = 0;
  if ( (unsigned int)Init(hInstance, lpCmdLine) )
  {
    v9 = DoMain();
    ...
    if ( v9 )
    {
      if ( !byte_14000CD1A[0] )
      {
        ...
        {
          if ( (dword_14000DE5C & 2) != 0 || g_uInfRebootOn || (v11 = g_dwRebootCheck, v11 != NeedRebootInit()) )
          {
            if ( (v10 & 4) != 0 || (unsigned int)MsgBox2Param(0, 0x522u, (__int64)pszCabPath, 0, 0x40u, 4) == 6 )
            {
              if ( g_wOSVer )
                MyNTReboot();
              else
...
__int64 __fastcall Init(HMODULE hModule, CHAR *lpsz)
{
  ...
  dword_14000D818 = 1;
  if ( (unsigned int)GetResource("TITLE", Destination, 0x7Fu) - 1 > 0x7F )
  {
    v5 = 1201;
    goto LABEL_33;
  }
  ...
  if ( (dword_14000DE64 & 0x40) != 0 || (dword_14000DE64 & 0x80u) != 0 )
  {
    ...
    if ( g_hMutex )
    {
      if ( GetLastError() == 183 )
      {
        ...
        {
          MsgBox2Param(0, 0x54Bu, (__int64)Destination, 0, 0x10u, 0);
LABEL_14:
          CloseHandle(g_hMutex);
          g_dwExitCode = -2147024713;
          return 0;
        }
        if ( (unsigned int)MsgBox2Param(0, 0x524u, (__int64)Destination, 0, 0x20u, 4) != 6 )
          goto LABEL_14;
      }
    }
  }
  g_uInfRebootOn = 0;
  if ( !(unsigned int)ParseCmdLine(lpsz) )
  {
    v5 = 1312;
LABEL_33:
    MsgBox2Param(0, v5, 0, 0, 0x10u, 0);
    return 0;
  }
  if ( byte_14000CD1A[0] )
  {
  ...
  else
  {
    ...
    if ( g_fOSSupportsFullUI )
      InitCommonControls();
    if ( dword_14000CD04
      || (unsigned int)CheckOSVersion((__int64)Resource)
      && ((unsigned __int16)(g_wOSVer - 1) > 2u
       ...
       || MyDialogBox(
            ...
            (const CHAR *)0x7D6,
            0,
            (INT_PTR (__stdcall *)(HWND, UINT, WPARAM, LPARAM))WarningDlgProc,
            1351,
            2110) == 2109) )
    {
      return 1;
...
__int64 DoMain()
{
  ...
  DWORD v8; // eax
  int v9; // eax
  CHAR Buffer[272]; // [rsp+30h] [rbp-238h] BYREF
  CHAR PathName[272]; // [rsp+140h] [rbp-128h] BYREF
...
LABEL_6:
  ...
  AddPath(Buffer, 0x105u, "advapi32.dll");
  LibraryA = LoadLibraryA(Buffer);
  v1 = LibraryA;
  if ( LibraryA )
  {
  ...
  {
    if ( !GetWindowsDirectoryA(PathName, 0x104u) )
    {
      v3 = 1264;
LABEL_15:
      MsgBox2Param(0, v3, 0, 0, 0x10u, 0);
    ...
    if ( !(unsigned int)IsEnoughSpace(PathName, 2, 2) )
      return 0;
  }
  ...
  if ( !dword_14000CD0C )
  {
    ...
    if ( (word_14000CD18 & 1) != 0 || (dword_14000DE64 & 1) != 0 )
      v7 = (unsigned int)ExtractThread(0) == 0;
    else
      v7 = MyDialogBox(
             0,
             (const CHAR *)(2005LL - (g_fOSSupportsFullUI != 0)),
             0,
             (INT_PTR (__stdcall *)(HWND, UINT, WPARAM, LPARAM))ExtractDlgProc,
             0,
             0) == 0;
    if ( v7 )
    {
    ...
    if ( !(unsigned int)TravelUpdatedFiles((unsigned int (__fastcall *)(_QWORD, _QWORD, char *, char *))ProcessUpdatedFile_Write) )
      return 0;
    g_dwExitCode = 0;
  }
...
__int64 __fastcall LicenseDlgProc(HWND hWnd, int a2, __int64 a3)
{
  ...
  if ( v4 )
  {
    ...
    if ( !v6 )
    {
      DesktopWindow = GetDesktopWindow();
      CenterWindow(hWnd, DesktopWindow);
      SetDlgItemTextA(hWnd, 2100, g_szLicense);
      SetWindowTextA(hWnd, Destination);
      SetForegroundWindow(hWnd);
      DlgItem = GetDlgItem(hWnd, 2100);
...
LABEL_8:
  ...
  {
    SendDlgItemMessageA(hWnd, 2100, 0xB1u, 0xFFFFFFFFFFFFFFFFuLL, 0);
    dword_14000C840 = 1;
  }
  return 0;
}
...
__int64 __fastcall TempDirDlgProc(HWND hWnd, int a2, __int64 a3)
{
  ...
  if ( v4 )
  {
    ...
    if ( !v5 )
    {
      ...
      CenterWindow(hWnd, DesktopWindow);
      SetWindowTextA(hWnd, Destination);
      SendDlgItemMessageA(hWnd, 2101, 0xC5u, 0x103u, 0);
      if ( g_wOSVer == 1 )
      {
        DlgItem = GetDlgItem(hWnd, 2102);
    ...
    if ( v7 )
    {
      ...
      if ( v8 )
      {
        if ( v8 == 2100 )
        {
          ...
          if ( StringA )
          {
            if ( !(unsigned int)BrowseForDir(hWnd) || SetDlgItemTextA(hWnd, 2101, pszDest) )
              return 1;
            v11 = 1216;
            v10 = hWnd;
          }
          ...
          MsgBox2Param(v10, v11, 0, 0, 0x10u, 0);
          v12 = 0;
          goto LABEL_32;
        }
      }
    ...
    if ( !GetDlgItemTextA(hWnd, 2101, &PathName, 260) )
      goto LABEL_33;
    v13 = -1;
    do
      ++v13;
    while ( *(&PathName + v13) );
    if ( v13 >= 3 && (byte_14000D611 == 58 || PathName == 92 && byte_14000D611 == 92) )
    {
      if ( GetFileAttributesA(&PathName) == -1 )
      {
        if ( (unsigned int)MsgBox2Param(hWnd, 0x54Au, (__int64)&PathName, 0, 0x20u, 4) != 6 )
          return 1;
        if ( !CreateDirectoryA(&PathName, 0) )
        {
          MsgBox2Param(hWnd, 0x4CBu, (__int64)&PathName, 0, 0x10u, 0);
          return 1;
        }
      }
      ...
      {
        if ( (PathName != 92 || byte_14000D611 != 92) && !(unsigned int)IsEnoughSpace(&PathName, 1, 1) )
          return 1;
        v12 = 1;
LABEL_32:
        EndDialog(hWnd, v12);
...
LABEL_33:
    ...
    MsgBox2Param(hWnd, v14, 0, 0, 0x10u, 0);
    return 1;
  }
  EndDialog(hWnd, 0);
  return 1;
...
LABEL_21:
  ...
  if ( a3 == 2 )
  {
    ...
    v11 = MsgBox2Param(g_hwndExtractDlg, 0x4B2u, (__int64)pszCabPath, 0, 0x20u, 4);
    if ( v11 != 6 && v11 != 1 )
    {
      SetEvent(g_hCancelEvent);
      return 1;
...
__int64 __fastcall CheckOSVersion(__int64 a1)
{
  ...
  int v17; // eax
  bool v18; // zf
  int v20[4]; // [rsp+38h] [rbp-D0h] BYREF
  _OSVERSIONINFOA VersionInformation; // [rsp+48h] [rbp-C0h] BYREF
  CHAR v22[272]; // [rsp+E8h] [rbp-20h] BYREF
...
LABEL_54:
  ...
  while ( 1 )
  {
    v8 = -1;
    v9 = 3 * v6;
    if ( VersionInformation.dwMajorVersion < *(_DWORD *)(v7 + 24LL * v6) )
    {
LABEL_17:
      v10 = -1;
      goto LABEL_22;
    ...
    if ( VersionInformation.dwMajorVersion <= *(_DWORD *)(v7 + 24LL * v6) )
    {
      if ( VersionInformation.dwMinorVersion < *(_DWORD *)(v7 + 24LL * v6 + 4) )
        goto LABEL_17;
      v10 = VersionInformation.dwMinorVersion > *(_DWORD *)(v7 + 24LL * v6 + 4);
    }
    else
    {
      v10 = 1;
...
LABEL_22:
    if ( VersionInformation.dwMajorVersion >= *(_DWORD *)(v7 + 24LL * v6 + 12) )
    {
      if ( VersionInformation.dwMajorVersion <= *(_DWORD *)(v7 + 24LL * v6 + 12) )
      {
        if ( VersionInformation.dwMinorVersion >= *(_DWORD *)(v7 + 24LL * v6 + 16) )
          v8 = VersionInformation.dwMinorVersion > *(_DWORD *)(v7 + 24LL * v6 + 16);
      }
      else
      {
        v8 = 1;
    ...
    if ( v10 >= 0 && v8 <= 0 )
    {
      if ( !v10 )
      {
        if ( v8 )
        {
          if ( (unsigned int)LOWORD(VersionInformation.dwBuildNumber) >= *(_DWORD *)(v7 + 24LL * v6 + 8) )
            goto LABEL_50;
        }
        else if ( (unsigned int)LOWORD(VersionInformation.dwBuildNumber) >= *(_DWORD *)(v7 + 24LL * v6 + 8) )
        {
          v11 = (unsigned int)LOWORD(VersionInformation.dwBuildNumber) <= *(_DWORD *)(v7 + 24LL * v6 + 20);
LABEL_37:
          if ( v11 )
            goto LABEL_50;
        }
...
LABEL_49:
  if ( v3 )
    goto LABEL_53;
LABEL_50:
  if ( !*(_DWORD *)(a1 + 124) || (unsigned int)CheckFileVersion(a1, v22, v9, v20) )
    goto LABEL_69;
  v5 = v20[0];
  v3 = 1357;
LABEL_53:
...
LABEL_40:
  ...
  if ( v7 )
  {
    v13 = (const CHAR *)(*(unsigned int *)(v7 + 52) + a1 + 132);
    v15 = *(_DWORD *)(v7 + 48);
    if ( (v15 & 1) != 0 )
      v14 = 260;
    else
  ...
  if ( (word_14000CD18 & 1) == 0 && v13 && *v13 )
  {
    MessageBeep(0);
    if ( !(unsigned int)RunningOnWin95BiDiLoc()
      || (v18 = (unsigned int)IsBiDiLocalizedBinary() == 0, v16 = 1572912, v18) )
    {
      v16 = 48;
    }
    v17 = MessageBoxA(0, v13, Destination, v14 | v16);
    if ( (v14 & 4) != 0 )
    {
      v18 = v17 == 6;
    }
  ...
  {
    MsgBox2Param(0, v3, (__int64)Destination, (__int64)v12, 0x30u, 0);
  }
LABEL_69:
  LOBYTE(v2) = v3 == 0;
  return v2;
...
__int64 DisplayLicense()
{
  ...
  if ( lstrcmpA(g_szLicense, "<None>") )
  {
    v4 = MyDialogBox(
           ...
           (const CHAR *)0x7D1,
           0,
           (INT_PTR (__stdcall *)(HWND, UINT, WPARAM, LPARAM))LicenseDlgProc,
           0,
           0);
    LocalFree((HLOCAL)g_szLicense);
    if ( !v4 )
...
__int64 RunInstallCommand()
{
  ...
  struct _STARTUPINFOA StartupInfo; // [rsp+88h] [rbp-80h] BYREF
...
LABEL_13:
    ...
    if ( !v0 )
      break;
LABEL_36:
    if ( !(unsigned int)AnalyzeCmd(String1, v4, (char **)&hMem, cbData) )
      return 0;
    v9 = cbData[0];
...
LABEL_43:
    ...
    {
      MsgBox2Param(0, 0x4C7u, 0, 0, 0x10u, 0);
      LocalFree(hMem);
      g_dwExitCode = -2147023829;
      return 0;
    }
...
LABEL_59:
      v13 = hMem;
      if ( !hMem || !(unsigned int)RunApps((LPSTR)hMem, &StartupInfo) )
        goto LABEL_64;
      goto LABEL_61;
    }
    Library = MyLoadLibrary();
    v11 = Library;
    if ( !Library )
    {
      MsgBox2Param(0, 0x4C8u, (__int64)"advpack.dll", 0, 0x10u, 0);
      goto LABEL_67;
    }
    ProcAddress = GetProcAddress(Library, aDoinfinstall);
    if ( !ProcAddress )
    {
      MsgBox2Param(0, 0x4C9u, (__int64)aDoinfinstall, 0, 0x10u, 0);
      FreeLibrary(v11);
LABEL_67:
      LocalFree(hMem);
      g_dwExitCode = MyGetLastError();
...
LABEL_70:
  ...
  {
    cbData[0] = 568;
    if ( !RegQueryValueExA((HKEY)hMem, g_szRegValName, 0, 0, Data, cbData) )
    {
      memset_0(Buffer, 0, 0x104u);
...
__int64 __fastcall RunApps(LPSTR lpCommandLine, LPSTARTUPINFOA lpStartupInfo)
{
  ...
  if ( !CreateProcessA(0, lpCommandLine, 0, 0, 0, 0x20u, 0, 0, lpStartupInfo, &ProcessInformation) )
  {
    ...
    MsgBox2Param(0, 0x4C4u, (__int64)lpCommandLine, (__int64)Buffer, 0x10u, 0);
    return 0;
  }
  ...
  if ( (dword_14000DE64 & 0x800) != 0 )
    goto LABEL_9;
  if ( g_uInfRebootOn
    || (v6 = g_dwRebootCheck, v6 != NeedRebootInit())
    || (v4 & 0xFF000000) == 0xAA000000 && (v4 & 1) != 0 )
  {
    g_dwExitCode = 3010;
    goto LABEL_17;
  }
...
HLOCAL FinishMessage()
{
  ...
  v2 = v1;
  if ( !v1 )
    return (HLOCAL)MsgBox2Param(0, 0x4B5u, 0, 0, 0x10u, 0);
  if ( (unsigned int)GetResource("FINISHMSG", v1, Resource) )
  {
    if ( lstrcmpA(v2, "<None>") )
      MsgBox2Param(0, 0x3E9u, (__int64)v2, 0, 0x40u, 0);
  }
  else
  {
    MsgBox2Param(0, 0x4B1u, 0, 0, 0x10u, 0);
...
__int64 __fastcall BrowseForDir(HWND hWnd)
{
  ...
  __int64 (__fastcall *v17)(HWND, int, __int64, LPARAM); // [rsp+58h] [rbp-40h]
...
LABEL_18:
  ...
  v16 = 1;
  v18 = g_szBrowsePath;
  v11 = ((__int64 (__fastcall *)(_QWORD *))ProcAddress)(v15);
  v12 = v11;
  if ( v11 )
  {
...
LABEL_23:
    ...
    if ( !(unsigned int)RunningOnWin95BiDiLoc() || (v25 = IsBiDiLocalizedBinary(), v26 = 1638400, !v25) )
      v26 = 0x10000;
    v12 = MessageBoxA(hWnd, v19, Destination, a6 | uType | v26);
    LocalFree(v19);
    return v12;
  }
  if ( !(unsigned int)RunningOnWin95BiDiLoc() || (v10 = IsBiDiLocalizedBinary(), v11 = 1638416, !v10) )
    v11 = 65552;
  MessageBoxA(hWnd, Text, Destination, v11);
  return -1;
}
  ...
  if ( FileAttributesA != -1 && (FileAttributesA & 0x10) == 0 )
  {
    ...
    if ( !dword_14000D600 && (word_14000CD18 & 1) == 0 )
    {
      ...
      v5 = MyDialogBox(
             ...
             (const CHAR *)0x7D3,
             g_hwndExtractDlg,
             (INT_PTR (__stdcall *)(HWND, UINT, WPARAM, LPARAM))OverwriteDlgProc,
             0,
             6)
         - 6;
      if ( v5 )
...
}INT_PTR __fastcall fdiNotifyExtract(FDINOTIFICATIONTYPE fdint, __int64 pfdin)
{
  ...
  if ( dword_14000D5FC )
  {
    if ( fdint == fdintCLOSE_FILE_INFO )
      closefunc(*(_QWORD *)(pfdin + 40));
    return -1;
  }
  if ( fdint == fdintCABINET_INFO )
    return (int)UpdateCabinetInfo(pfdin);
  v4 = fdint - 1;
  if ( !v4 )
    return 0;
  v5 = v4 - 1;
  ...
  {
    if ( g_hwndExtractDlg )
      SetDlgItemTextA(g_hwndExtractDlg, 2103, *(LPCSTR *)(pfdin + 8));
    v12 = *(char **)(pfdin + 8);
    v13 = -1;
    do
      ++v13;
    ...
    do
      ++v14;
    while ( *(&PathName + v14) );
    if ( (int)v14 + (int)v13 + 1 >= 260 || !(unsigned int)CatDirAndFile(FileName, &PathName, v12) )
      return -1;
    if ( (unsigned int)CheckOverwrite(FileName) )
    {
      v15 = openfunc(FileName, 33538, 384);
      if ( v15 == -1 || !(unsigned int)AddFile(FileName) )
        return -1;
      ++dword_14000D820;
      return v15;
    }
  ...
  do
    ++v9;
  while ( *(&PathName + v9) );
  if ( (int)v9 + (int)v8 + 1 >= 260 )
    return -1;
  if ( !(unsigned int)CatDirAndFile(FileName, &PathName, v7) )
    return -1;
  v10 = 32LL * *(_QWORD *)(pfdin + 40);
  if ( *(_DWORD *)((char *)&g_FileTable + v10 + 4) == 1
    || !DosDateTimeToFileTime(*(_WORD *)(pfdin + 48), *(_WORD *)(pfdin + 50), &FileTime)
    || !LocalFileTimeToFileTime(&FileTime, &CreationTime)
    || !SetFileTime(*(HANDLE *)((char *)&g_FileTable + v10 + 24), &CreationTime, &CreationTime, &CreationTime) )
  {
    return -1;
  }
  closefunc(*(_QWORD *)(pfdin + 40));
  v11 = *(_WORD *)(pfdin + 52) ? *(_WORD *)(pfdin + 52) & 0x27 : 128;
  if ( !SetFileAttributesA(FileName, v11) )
    return -1;
  return 1;
}
...
_BOOL8 VerifyCabinet()
{
  ...
  INT_PTR v2; // rbx
  _BOOL8 result; // rax
  FDICABINETINFO pfdici; // [rsp+50h] [rbp-38h] BYREF
  ERF v5; // [rsp+68h] [rbp-20h] BYREF
  ...
  if ( v0 )
  {
    ...
    v2 = v1;
    if ( v1 != -1
      && FDIIsCabinet(v0, v1, &pfdici)
      && pfdici.cbCabinet == dword_14000D568
      && !pfdici.hasprev
      && !pfdici.hasnext
...
LABEL_3:
  ...
  if ( !(unsigned int)TravelUpdatedFiles((unsigned int (__fastcall *)(_QWORD, _QWORD, char *, char *))ProcessUpdatedFile_Size) )
  {
...
LSTATUS DeleteExtractedFiles()
{
  ...
  CHAR szStart[272]; // [rsp+40h] [rbp-128h] BYREF
  ...
  if ( g_wOSVer != 1 )
  {
    if ( result )
    {
      if ( g_szRegValName[0] )
      {
        result = RegOpenKeyExA(HKEY_LOCAL_MACHINE, SubKey, 0, 0x20006u, &hKey);
        if ( !result )
        {
          RegDeleteValueA(hKey, g_szRegValName);
          result = RegCloseKey(hKey);
        }
      }
    }
...
__int64 __fastcall GetNewTempDir(LPCSTR lpPathName, STRSAFE_LPSTR pszDest)
{
  unsigned int v2; // ebx
  int v4; // esi
  char pszDesta[272]; // [rsp+20h] [rbp-138h] BYREF

  v2 = 0;
  v4 = 0;
  while ( 1 )
  {
    StringCchPrintfA(pszDesta, 0x104u, "IXP%03d.TMP", v4++);
    StringCchCopyA(pszDest, 0x104u, lpPathName);
    AddPath(pszDest, 0x104u, pszDesta);
    RemoveDirectoryA(pszDest);
    if ( GetFileAttributesA(pszDest) == -1 )
      break;
    if ( v4 >= 400 )
      goto LABEL_4;
  }
  if ( CreateDirectoryA(pszDest, 0) )
  {
    g_CMD = 1;
    return 1;
  }
LABEL_4:
  if ( GetTempFileNameA(lpPathName, "IXP", 0, pszDest) )
  {
    v2 = 1;
    DeleteFileA(pszDest);
...
__int64 __fastcall CreateAndValidateSubdir(const CHAR *a1, int a2, int a3)
{
  ...
  CHAR v13; // al
  CHAR *v14; // rax
  _SYSTEM_INFO SystemInfo; // [rsp+20h] [rbp-158h] BYREF
  char pszDest[272]; // [rsp+50h] [rbp-128h] BYREF

  if ( a2 )
  {
    if ( !(unsigned int)GetNewTempDir(a1, pszDest) )
      return 0;
    v5 = 260;
    v6 = &PathName;
    do
...
LABEL_30:
  if ( a3 && !(unsigned int)IsEnoughSpace(&PathName, a3, 0) )
  {
    if ( g_CMD )
    {
      g_CMD = 0;
...
__int64 GetTempDirectory()
{
  ...
  DWORD TotalNumberOfClusters; // [rsp+40h] [rbp-C8h] BYREF
  ...
  if ( sz )
  {
    if ( sz != 92 || (v8 = 0, byte_14000CE1F != 92) )
      v8 = 1;
    if ( !(unsigned int)CreateAndValidateSubdir(&sz, 0, v8) )
    {
...
LABEL_56:
      ...
      if ( !(unsigned int)IsEnoughSpace(RootPathName, 3, 4) )
        return 0;
    }
    while ( 1 )
    {
      ...
      if ( !(unsigned int)IsEnoughSpace(RootPathName, 3, 0)
        && ((unsigned int)IsWindowsDrive(RootPathName) || !(unsigned int)IsEnoughSpace(RootPathName, 1, 0)) )
      {
        break;
      }
...
LABEL_36:
  ...
  LOBYTE(v2) = MyDialogBox(
                 v7,
                 (const CHAR *)0x7D2,
                 0,
                 (INT_PTR (__stdcall *)(HWND, UINT, WPARAM, LPARAM))TempDirDlgProc,
                 0,
                 0) != 0;
  return v2;
}
...
__int64 __fastcall IsEnoughSpace(LPCSTR lpPathName, char a2, int a3)
{
  ...
  _BYTE v28[8]; // [rsp+60h] [rbp-A8h] BYREF
...
LABEL_31:
  ...
  *v14 = 0;
  ...
  if ( !v19 )
    return DiskSpaceErrMsg(a3, v17, v18, (__int64)v28);
  g_dwExitCode = 0;
  return 1;
}
        ...
        switch ( v8 )
        {
          ...
          case 'C':
            ...
            if ( v43 == 58 )
            {
              ...
              while ( v33[v34] );
              if ( v34
                && (!ANSIStrChr(&v41 + 4 - (unsigned int)(v44[0] != 34), 91) || ANSIStrChr(v33, 93))
                && (!ANSIStrChr(v33, 93) || ANSIStrChr(v33, 91)) )
              {
                v40[0] = v32;
...
LABEL_90:
            ...
            if ( v19 == 84 )
            {
              v21 = &sz;
              v22 = &sz;
              v23 = &v41 + (int)(v16 + v40[0]) - (_QWORD)&sz;
              do
              {
                if ( v20 == -2147483386 )
                  break;
...
LABEL_28:
      v2 = 0;
LABEL_29:
      if ( dword_14000CD0C && !sz )
      {
        if ( GetModuleFileNameA(g_hInst, &sz, 0x104u) )
          *((_BYTE *)ANSIStrRChr(&sz, 92) + 1) = 0;
        else
          return 0;
      }
      return v2;
...
__int64 __fastcall ProcessUpdatedFile_Write(DWORD nNumberOfBytesToWrite, __int64 a2, const char *a3, const void *a4)
{
  ...
  CHAR FileName[272]; // [rsp+50h] [rbp-138h] BYREF
...
__int64 RunningOnWin95BiDiLoc()
{
  ...
  struct _OSVERSIONINFOA VersionInformation; // [rsp+58h] [rbp-B0h] BYREF
...
LABEL_18:
    ...
    if ( _dyn_tls_init_callback && (unsigned int)IsNonwritableInCurrentImage((__int64)&_dyn_tls_init_callback) )
...
__int64 __fastcall IsNonwritableInCurrentImage(__int64 a1)
{
  ...
  result = ValidateImageBase(0x140000000LL);
  if ( (_DWORD)result )
  {
