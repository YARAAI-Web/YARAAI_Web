#include "090c9d70-9e42-4d79-ad30-48e954d436db.h"
...
int __thiscall AnalyzeCmd(STRSAFE_LPSTR pszDest, char **a2, _DWORD *a3)
{
  ...
  else
  {
    ...
    AddPath(FileName, 0x104u, v8);
  }
  v11 = ANSIStrRChr(v8, 46);
  if ( v11 && CompareStringA(0x7Fu, 1u, v11, -1, ".INF", -1) == 2 )
  {
    ...
    {
      MsgBox2Param(0, 0x525u, FileName, 0, 0x10u, 0);
      return 0;
    }
    pszDesta = v9;
  ...
  if ( !v19 || CompareStringA(0x7Fu, 1u, v19, -1, ".BAT", -1) != 2 )
  {
    ...
    if ( v14 )
    {
      ...
      *v14 = 0;
      ExpandCmdParams((BYTE *)sz, (unsigned int)v14, v14);
      goto LABEL_48;
    }
    goto LABEL_38;
  }
...
int __fastcall MyRestartDialog(char a1)
{
  ...
  {
    if ( (a1 & 4) != 0 || (result = MsgBox2Param(0, 0x522u, pszCabPath, 0, 0x40u, 4), result == 6) )
    {
      if ( g_wOSVer )
        return MyNTReboot();
      else
...
HLOCAL __stdcall AddRegRunOnce()
{
  ...
  if ( !result )
  {
    ...
    AddPath(Buffer, 0x104u, (STRSAFE_LPSTR)"advpack.dll");
          ...
          DelNodeRunDLL32) )
    {
      if ( GetSystemDirectoryA(Filename, 0x104u) )
        AddPath(Filename, 0x104u, (STRSAFE_LPSTR)pszCabPath);
    }
  ...
  if ( g_szRegValName && !RegOpenKeyExA(HKEY_LOCAL_MACHINE, SubKey, 0, 0x2001Fu, &phkResult) )
  {
    ...
    if ( !RegQueryValueExA(phkResult, &g_szRegValName, 0, 0, Data, &cbData) )
    {
      ...
      if ( GetSystemDirectoryA(Buffer, 0x104u) )
        AddPath(Buffer, 0x104u, (STRSAFE_LPSTR)pszCabPath);
      StringCchPrintfA(
        (STRSAFE_LPSTR)Data,
        0x238u,
          ...
          if ( (FindFileData.dwFileAttributes & 0x10) != 0 )
          {
            if ( lstrcmpA(FindFileData.cFileName, ".") )
            {
              if ( lstrcmpA(FindFileData.cFileName, "..") )
              {
                ...
                AddPath(pszDest, 0x104u, (STRSAFE_LPSTR)pszCabPath);
                DeleteMyDir(pszDest);
              }
            }
          }
...
LONG __stdcall GetWininitSize()
{
  ...
  {
    AddPath(Buffer, 0x104u, (STRSAFE_LPSTR)"wininit.ini");
...
BOOL __fastcall DiskSpaceErrMsg(int a1, int a2, int a3, const char *a4)
{
  ...
  switch ( a1 )
  {
    case 1:
      ...
      MsgBox2Param(0, 0x4FAu, pszDest, 0, 0x10u, 0);
      break;
    case 4:
      StringCchPrintfA(pszDest, 0xAu, "%lu", a2 + a3);
      return MsgBox2Param(0, 0x4BDu, pszDest, 0, 0x20u, 5) == 4;
    case 2:
      StringCchPrintfA(pszDest, 0xAu, "%lu", a3);
      if ( MsgBox2Param(0, 0x4CCu, pszDest, a4, 0x40u, 260) == 6 )
      {
        g_dwExitCode = 0;
        return 1;
      }
...
LABEL_16:
      AddPath(lpszStart, 0x104u, pszDest);
      return 1;
    }
  }
...
int __fastcall CheckFileVersion(int a1, const CHAR *a2, int a3, _DWORD *a4)
{
  ...
  unsigned int v21; // [esp-4h] [ebp-4Ch]
  _DWORD v22[2]; // [esp+Ch] [ebp-3Ch]
  _DWORD v23[3]; // [esp+14h] [ebp-34h]
...
LABEL_20:
  ...
  else
  {
    ...
    {
      v29 = *(_DWORD *)(v4 + 128);
      if ( !GetFileTobeChecked((CHAR *)lptstrFilename, v4 + 132 + *(_DWORD *)(v4 + v8 + v29 + 188)) )
        break;
        ...
        if ( GetFileVersionInfoA(lptstrFilename, dwHandle, dwLen, v11) )
        {
          if ( VerQueryValueA(pBlock, "\\", &lpBuffer, &puLen) )
          {
            if ( puLen )
            {
              ...
              v23[2] = v13;
              v15 = v13;
              pBlock = (LPCVOID)(v29 + 148 + v31 + v33);
              v16 = (unsigned int *)pBlock;
              do
              {
                v17 = CompareVersion(v15, v14, *(v16 - 4), *(v16 - 3));
                v21 = *v16;
                v23[v12] = v17;
                v22[v12] = CompareVersion(v19, v18, *(v16 - 1), v21);
                v16 += 6;
                ++v12;
              }
              while ( v12 < 2 );
              v6 = v30;
              v5 = 0;
              if ( (v23[0] < 0 || v22[0] > 0) && (v23[1] < 0 || v22[1] > 0) )
              {
                GlobalUnlock(v7);
                break;
              }
      ...
      else
      {
        v4 = v31;
        v6 = v30;
        if ( *(_DWORD *)(v31 + v33 + v29 + 132) || *(_DWORD *)(v31 + v33 + v29 + 136) )
          break;
      }
      ++v6;
      v8 = v33 + 60;
...
int __fastcall Init(HMODULE hModule, CHAR *lpsz, int a3)
{
  ...
  HRSRC ResourceA; // eax
  int v10; // ecx
  DWORD v11; // [esp+0h] [ebp-114h]
  DWORD *v12; // [esp+4h] [ebp-110h]
  ...
  if ( (dword_409A34 & 0xC0) != 0 )
  {
    ...
    if ( g_hMutex )
    {
      if ( GetLastError() == 183 )
      {
        ...
        {
          MsgBox2Param(0, 0x54Bu, Destination, 0, 0x10u, 0);
LABEL_12:
          CloseHandle(g_hMutex);
          g_dwExitCode = -2147024713;
          return 0;
        }
        if ( MsgBox2Param(0, 0x524u, Destination, 0, 0x20u, 4) != 6 )
          goto LABEL_12;
      }
    }
  }
...
LABEL_6:
  ...
  AddPath(Buffer, 0x105u, (STRSAFE_LPSTR)"advapi32.dll");
  LibraryA = LoadLibraryA(Buffer);
  v1 = LibraryA;
  v2 = 0;
  if ( LibraryA )
...
int __stdcall TempDirDlgProc(HWND hDlg, int a2, int a3, int a4)
{
  ...
  if ( a3 == 1 )
  {
    ...
    {
      MsgBox2Param(hDlg, 0x4BFu, 0, 0, 0x10u, 0);
      return 1;
    }
    if ( GetFileAttributesA(&PathName) == -1 )
    {
      if ( MsgBox2Param(hDlg, 0x54Au, &PathName, 0, 0x20u, 4) != 6 )
        return 1;
      if ( !CreateDirectoryA(&PathName, 0) )
      {
        MsgBox2Param(hDlg, 0x4CBu, &PathName, 0, 0x10u, 0);
        return 1;
      }
    }
    AddPath(&PathName, 0x104u, (STRSAFE_LPSTR)pszCabPath);
    if ( !IsGoodTempDir(&PathName) )
    {
      MsgBox2Param(hDlg, 0x4BEu, 0, 0, 0x10u, 0);
      return 1;
    }
    if ( PathName == 92 && byte_4091E5 == 92 || IsEnoughSpace(&PathName, 1, 1) )
      EndDialog(hDlg, 1);
    return 1;
  }
  if ( a3 == 2 )
  ...
  v6 = 1201;
LABEL_10:
  MsgBox2Param(hDlg, v6, 0, 0, 0x10u, 0);
  EndDialog(hDlg, 0);
  return 1;
}
...
LABEL_18:
    ...
    case 272:
      ...
      if ( !hThread )
      {
        MsgBox2Param(hDlg, 0x4B8u, 0, 0, 0x10u, 0);
        EndDialog(hDlg, 0);
      }
      return 1;
    case 273:
      ...
      v5 = MsgBox2Param(g_hwndExtractDlg, 0x4B2u, pszCabPath, 0, 0x20u, 4);
      if ( v5 != 6 && v5 != 1 )
      {
        SetEvent(g_hCancelEvent);
        return 1;
...
BOOL __thiscall CheckOSVersion(_DWORD *this)
{
  ...
  const char *v21; // [esp+28h] [ebp-1A8h] BYREF
  int v22; // [esp+2Ch] [ebp-1A4h]
  const char *v23; // [esp+30h] [ebp-1A0h]
...
LABEL_14:
  ...
  while ( 1 )
  {
    ...
    v19 = CompareVersion(
            ...
            *(_DWORD *)&v5[24 * (_DWORD)v2],
            *(_DWORD *)&v5[24 * (_DWORD)v2 + 4]);
...
LABEL_30:
  ...
  if ( v3 == 1357 )
  {
    v11 = (char *)&this[15 * (_DWORD)v2 + 33] + this[32];
    v23 = v25;
  }
  else
  {
  ...
  {
    MessageBeep(0);
    if ( RunningOnWin95BiDiLoc() && IsBiDiLocalizedBinary(v13, (int)v13) )
      v14 = 1572912;
    else
      v14 = 48;
  ...
  {
    MsgBox2Param(0, v3, Destination, v23, 0x30u, 0);
  }
  return v3 == 0;
}
...
int __thiscall ExtractFiles(void *this)
{
  ...
  if ( (word_408A38 & 1) != 0 || (dword_409A34 & 1) != 0 )
    ...
    Thread = MyDialogBox(
               (int)this,
               (const CHAR *)(2005 - (g_fOSSupportsFullUI != 0)),
               0,
  ...
  if ( !TravelUpdatedFiles((int (__thiscall *)(_DWORD, _DWORD, _DWORD, const char *, const char *))ProcessUpdatedFile_Write) )
    return 0;
  g_dwExitCode = 0;
  return 1;
}
...
LABEL_56:
    ...
    Library = MyLoadLibrary(v8);
    v11 = Library;
    if ( !Library )
    {
      MsgBox2Param(0, 0x4C8u, "advpack.dll", 0, 0x10u, 0);
      goto LABEL_63;
    }
    ...
    if ( !DoInfInstall )
    {
      MsgBox2Param(0, 0x4C9u, aDoinfinstall, 0, 0x10u, 0);
      FreeLibrary(v11);
LABEL_63:
      LocalFree(hMem);
      g_dwExitCode = MyGetLastError();
...
int __fastcall RunApps(LPSTR lpCommandLine, LPSTARTUPINFOA lpStartupInfo)
{
  ...
  if ( lpCommandLine )
  {
    ...
    else
    {
      ...
      MsgBox2Param(0, 0x4C4u, lpCommandLine, Buffer, 0x10u, 0);
    }
    return 0;
  }
  return result;
...
HLOCAL __stdcall FinishMessage()
{
  ...
  {
    if ( lstrcmpA(v2, "<None>") )
      MsgBox2Param(0, 0x3E9u, v2, 0, 0x40u, 0);
  }
  else
  {
    MsgBox2Param(0, 0x4B1u, 0, 0, 0x10u, 0);
...
BOOL __thiscall BrowseForDir(HWND this, int a2, int a3)
{
    ...
    || (SHGetPathFromIDList = GetProcAddress(v5, aShgetpathfromi)) == 0 )
  {
    ...
    v9 = 1217;
LABEL_16:
    MsgBox2Param(this, v9, 0, 0, 0x10u, 0);
    return 0;
  }
  if ( !g_szBrowsePath[0] )
  {
...
int __fastcall MsgBox2Param(HWND a1, UINT a2, const char *a3, const char *a4, UINT uType, int a6)
{
  ...
  if ( !Buffer[0] )
  {
    if ( !RunningOnWin95BiDiLoc() || (v7 = IsBiDiLocalizedBinary(v6, (int)v6) == 0, v8 = 1638416, v7) )
      v8 = 65552;
...
LABEL_16:
  MessageBeep(uType);
  if ( !RunningOnWin95BiDiLoc() || (v7 = IsBiDiLocalizedBinary(v14, (int)v14) == 0, v15 = 1638400, v7) )
    v15 = 0x10000;
...
INT_PTR __cdecl fdiNotifyExtract(FDINOTIFICATIONTYPE fdint, PFDINOTIFICATION pfdin)
{
  ...
  switch ( fdint )
  {
    case fdintCABINET_INFO:
      return UpdateCabinetInfo((int)pfdin);
...
LABEL_3:
  ...
  if ( !TravelUpdatedFiles((int (__thiscall *)(_DWORD, _DWORD, _DWORD, const char *, const char *))ProcessUpdatedFile_Size) )
  {
  ...
  if ( a2 )
  {
    ...
    if ( (dword_409A34 & 0x20) != 0 )
    {
      ...
      if ( SystemInfo.wProcessorArchitecture )
      {
        ...
        {
          case 1u:
            AddPath(&PathName, 0x104u, "mips");
            break;
          case 2u:
            AddPath(&PathName, 0x104u, "alpha");
            break;
          case 3u:
            AddPath(&PathName, 0x104u, "ppc");
            break;
        }
      }
      else
      {
        AddPath(&PathName, 0x104u, (STRSAFE_LPSTR)"i386");
      }
    }
    AddPath(&PathName, 0x104u, (STRSAFE_LPSTR)pszCabPath);
  }
...
LABEL_17:
  if ( a3 && !IsEnoughSpace(&PathName, a3, 0) )
  {
    if ( g_CMD )
    {
      g_CMD = 0;
...
BOOL __stdcall GetTempDirectory()
{
  ...
  STRSAFE_LPSTR v13; // ecx
  const char *v14; // [esp+0h] [ebp-114h]
  size_t v15; // [esp+4h] [ebp-110h]
  ...
  if ( szStart )
  {
    if ( szStart != 92 || (v5 = 0, byte_408B3F != 92) )
      v5 = 1;
    if ( !CreateAndValidateSubdir(&szStart, 0, v5) )
    {
  ...
  if ( !dword_408A24 && !dword_409A30 )
  {
    ...
    while ( 1 )
    {
      StringCopyWorkerA(v6, (size_t)"A:\\", (size_t *)v6, v14, v15);
      if ( RootPathName[0] <= 90 )
        break;
LABEL_43:
      GetWindowsDirectoryA(RootPathName, 0x104u);
      if ( !IsEnoughSpace(RootPathName, 3, 4) )
        return 0;
    }
    while ( 1 )
    {
      ...
      if ( v8 == 2 )
      {
        ...
        {
LABEL_49:
          if ( IsEnoughSpace(RootPathName, 3, 0) || !IsWindowsDrive(RootPathName) && IsEnoughSpace(RootPathName, 1, 0) )
          {
            if ( IsWindowsDrive(RootPathName) )
              GetWindowsDirectoryA(RootPathName, 0x104u);
            AddPath(RootPathName, 0x104u, (STRSAFE_LPSTR)"msdownld.tmp");
            ...
            if ( DirectoryA )
            {
              ...
              StringCopyWorkerA(v13, (size_t)RootPathName, (size_t *)v13, v14, v15);
...
int __thiscall IsGoodTempDir(char *lpFileName)
{
  ...
  v3 = (CHAR *)LocalAlloc(0x40u, v2 + 20);
  if ( !v3 )
  {
    MsgBox2Param(0, 0x4B5u, 0, 0, 0x10u, 0);
LABEL_3:
  ...
  StringCchCopyA(lpFileName, v6, v7);
  AddPath(v3, v2 + 20, (STRSAFE_LPSTR)"TMP4351$.TMP");
  hObject = CreateFileA(v3, 0x40000000u, 0, 0, 1u, 0x4000080u, 0);
  LocalFree(v3);
  if ( hObject == (HANDLE)-1 )
    goto LABEL_3;
  CloseHandle(hObject);
...
BOOL __fastcall IsEnoughSpace(LPCSTR lpPathName, int a2, int a3)
{
  ...
  char v28[8]; // [esp+32Ch] [ebp-Ch] BYREF
...
LABEL_31:
  ...
  *v8 = 0;
  ...
  if ( !v16 )
    return DiskSpaceErrMsg(a3, v14, v15, v28);
  g_dwExitCode = 0;
  return 1;
}
...
int __thiscall ParseCmdLine(LPSTR lpsz)
{
  ...
  CHAR *v30; // esi
  int v32; // ebx
  size_t v33; // [esp+0h] [ebp-11Ch]
  const char *v34; // [esp+4h] [ebp-118h]
  int v35; // [esp+Ch] [ebp-110h] BYREF
  LPSTR v36; // [esp+10h] [ebp-10Ch]
  char v37; // [esp+14h] [ebp-108h] BYREF
  CHAR String2; // [esp+15h] [ebp-107h] BYREF
  char v39; // [esp+16h] [ebp-106h]
  char v40[257]; // [esp+17h] [ebp-105h] BYREF
  ...
  while ( 1 )
  {
    ...
    while ( *v36 );
    if ( v4 >= 0x104 )
      __report_rangecheckfailure((int)v3, v7, v4, v6, v1, v5, v33);
    *(&v37 + v4) = 0;
    if ( !v5 )
      break;
    if ( !v6 )
...
LABEL_41:
    if ( v37 != 47 && v37 != 45 )
      return 0;
    v10 = (char)CharUpperA((LPSTR)String2) - 63;
    if ( !v10 )
    {
    ...
    if ( !v11 )
    {
      ...
      if ( v39 == 58 )
      {
        ...
        if ( strlen(&v37 + v32) )
        {
          if ( (!ANSIStrChr(&v37 + v32, 91) || ANSIStrChr(&v37 + v32, 93))
            && (!ANSIStrChr(&v37 + v32, 93) || ANSIStrChr(&v37 + v32, 91)) )
          {
            v35 = v32;
            if ( RemoveLeadTailBlanks(&v37 + v32, &v35) )
            {
              StringCchCopyA(&v37 + v32 + v35, v33, v34);
              goto LABEL_51;
            }
          }
        }
...
LABEL_50:
    ...
    if ( v12 )
    {
      ...
      if ( !v13 )
      {
        ...
        if ( v39 == 58 )
        {
          ...
          if ( v40[0] )
          {
            ...
            {
              ++v26;
              v27 = (char)CharUpperA((LPSTR)v25) - 69;
              if ( v27 )
              {
                v28 = v27 - 2;
                if ( v28 )
      ...
      if ( !v14 )
      {
        ...
        if ( v39 == 58 )
        {
          v24 = (unsigned __int8)CharUpperA((LPSTR)v40[0]);
          switch ( v24 )
          {
            case '1':
              goto LABEL_77;
...
LABEL_84:
      ...
      if ( !v15 )
      {
        ...
        if ( v39 == 58 )
        {
          ...
          {
            ++v17;
            v18 = (char)CharUpperA((LPSTR)v16) - 65;
            if ( v18 )
            {
              v19 = v18 - 3;
              if ( v19 )
...
LABEL_72:
    ...
    if ( !strlen(&v37 + v29) )
      goto LABEL_50;
    v35 = (v40[0] == 34) + 3;
    if ( !RemoveLeadTailBlanks(&v37 + v29, &v35) )
      goto LABEL_50;
    v30 = &szStart;
    if ( (unsigned __int8)CharUpperA((LPSTR)String2) != 84 )
      v30 = &byte_408A3A;
    StringCchCopyA(&v37 + v29 + v35, v33, v34);
    AddPath(v30, 0x104u, (STRSAFE_LPSTR)pszCabPath);
    if ( !IsFullPath((int)v30) )
      return 0;
LABEL_51:
    lpsz = v36;
    if ( !*v36 )
        ...
        const void *a5)
{
  ...
  AddPath(FileName, 0x104u, pszDest);
...
HMODULE __thiscall MyLoadLibrary(size_t *pcchNewDestLength)
{
  ...
  AddPath((CHAR *)FileName, 0x104u, (STRSAFE_LPSTR)"advpack.dll");
...
int pre_c_init()
{
  ...
  LOBYTE(v0) = check_managed_app();
  dword_4081F8 = v0;
  image_app_type = _get_image_app_type(2);
  ___set_app_type(image_app_type);
  __onexitend = -1;
  __onexitbegin = -1;
  *___p__fmode() = _fmode;
  *___p__commode() = _commode;
  _setargv();
  if ( !__defaultmatherr )
    ___setusermatherr((_UserMathErrorFunctionPointer)_setargv);
...
{
  return _except_handler4_common((int)&__security_cookie, (int)__security_check_cookie, a1, a2, a3, a4);
}
