#include "e2d5c912-f82e-49cd-b7a0-7be4d1d8a948.h"
...
WCHAR *__fastcall sub_62743EA0(_DWORD *a1, int a2, const CHAR *a3, const char *a4, int a5, DWORD *a6)
{
  WCHAR *v9; // rbx
  WCHAR *v10; // rax
  size_t v11; // rdi
    ...
    if ( *((_DWORD *)v11 + 1) )
    {
      ...
      do
      {
        switch ( *(_DWORD *)v16 )
        {
          ...
          case 4:
            v34 = v16 + 16;
            v35 = sub_62743EA0(v60, *((_DWORD *)v16 + 1), v16 + 16, v41, 1, (DWORD *)&v51);
            v47 = v35;
            v16 += 16;
            if ( v35 )
            {
...
__int64 __fastcall sub_627477A0(HKEY *String)
{
  ...
  __int64 v5; // rbx
  size_t v6; // rax
  char *lpMem; // [rsp+28h] [rbp-20h] BYREF
  ...
  if ( v2 )
  {
    ...
    else
    {
      ...
      do
      {
        ...
        if ( !wcsncmp(*(const wchar_t **)&lpMem[v5], (const wchar_t *)String, v6) )
        {
          v3 = 1;
          goto LABEL_7;
        }
