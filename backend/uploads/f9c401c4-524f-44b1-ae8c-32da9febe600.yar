rule AutoGen_5a75d087 : Malware {
    ...
    strings:
        ...
        $s527 = "ae8c" fullword ascii
        $s528 = "allocfunc" fullword ascii
        $s529 = "alpha" fullword ascii
        $s530 = "amsg_exit_0" fullword ascii
        $s531 = "attributes" fullword ascii
