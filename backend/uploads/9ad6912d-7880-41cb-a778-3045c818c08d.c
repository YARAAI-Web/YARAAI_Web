#include "9ad6912d-7880-41cb-a778-3045c818c08d.h"
...
LABEL_53:
  ...
  if ( !v41 || CompareStringA(0x7Fu, 1u, v41, -1, ".BAT", -1) != 2 )
  {
    ...
    if ( v34 )
    {
      v46 = GetFileAttributesA(FileName);
      if ( v46 == -1 || (v46 & 0x10) != 0 )
      {
  ...
  if ( !v44 )
    goto LABEL_53;
  StringCchPrintfA(v44, v43 + 8, "Command.com /c %s", FileName);
LABEL_82:
  *a3 = v34;
  return 1;
}
    ...
    if ( v9 )
    {
      if ( !byte_14000CD1A )
      {
        ...
        if ( (dword_14000DE5C & 1) != 0 )
        {
          ...
          {
            if ( (v10 & 4) != 0 || (unsigned int)MsgBox2Param(0, 0x40u, 4) == 6 )
            {
              if ( g_wOSVer )
                MyNTReboot();
              else
...
__int64 __fastcall Init(HMODULE hModule, LPCSTR lpsz)
{
...
LABEL_14:
    ...
    if ( !(unsigned int)IsEnoughSpace(PathName) )
      return 0;
  }
    ...
    if ( GetDlgItemTextA(hWnd, 2101, &PathName, 260) )
    {
      ...
      if ( v12 >= 3 && (byte_14000D611 == 58 || PathName == 92 && byte_14000D611 == 92) )
      {
        if ( GetFileAttributesA(&PathName) != -1 )
          goto LABEL_25;
        if ( (unsigned int)MsgBox2Param(hWnd, 0x20u, 4) != 6 )
          return 1;
...
LABEL_40:
  ...
  if ( (word_14000CD18 & 1) == 0 && v12 && *v12 )
  {
    ...
    v16 = MessageBoxA(0, v12, Destination, v13 | v15);
    if ( (v13 & 4) != 0 )
    {
      v17 = v16 == 6;
    }
...
}INT_PTR __fastcall fdiNotifyExtract(FDINOTIFICATIONTYPE fdint, PFDINOTIFICATION pfdin)
{
  ...
  if ( !v5 )
  {
    ...
    do
      ++v14;
    while ( *(&PathName + v14) );
    if ( (int)v14 + (int)v13 + 1 >= 260 || !(unsigned int)CatDirAndFile(FileName, &PathName, psz1) )
      return -1;
  ...
  closefunc(pfdin->hf);
  v11 = pfdin->attribs ? pfdin->attribs & 0x27 : 128;
