rule AutoGen_5a75d087 : Malware {
    ...
    strings:
        ...
        $s592 = "else" fullword ascii
        $s593 = "erfOper" fullword ascii
        $s594 = "exit" fullword ascii
        $s595 = "fdiNotifyExtract" fullword ascii
        $s596 = "fdint" fullword ascii
        $s597 = "freefunc" fullword ascii
        $s598 = "g_CMD" fullword ascii
        $s599 = "g_FileTable" fullword ascii
        $s600 = "g_Sess" fullword ascii
        $s601 = "g_bConvertRunOnce" fullword ascii
        $s602 = "g_dwExitCode" fullword ascii
        $s603 = "g_dwFileSizes" fullword ascii
        $s604 = "g_dwRebootCheck" fullword ascii
        $s605 = "g_fOSSupportsFullUI" fullword ascii
        $s606 = "g_fOSSupportsINFInstalls" fullword ascii
        $s607 = "g_hCancelEvent" fullword ascii
        $s608 = "g_hInst" fullword ascii
        $s609 = "g_hMutex" fullword ascii
        $s610 = "g_hwndExtractDlg" fullword ascii
        $s611 = "g_lpfnOldMEditWndProc" fullword ascii
        $s612 = "g_szBrowsePath" fullword ascii
        $s613 = "g_szLicense" fullword ascii
        $s614 = "g_szRegValName" fullword ascii
        $s615 = "g_uInfRebootOn" fullword ascii
        $s616 = "g_wOSVer" fullword ascii
        $s617 = "get_image_app_type" fullword ascii
        $s618 = "guard_check_icall_nop" fullword ascii
        $s619 = "guard_dispatch_icall_nop" fullword ascii
        $s620 = "hDlg" fullword ascii
        $s621 = "hInstance" fullword ascii
        $s622 = "hKey" fullword ascii
        $s623 = "hMem" fullword ascii
        $s624 = "hModule" fullword ascii
        $s625 = "hPrevInstance" fullword ascii
        $s626 = "hProcess" fullword ascii
        $s627 = "hThread" fullword ascii
        $s628 = "hWnd" fullword ascii
        $s629 = "i386" fullword ascii
        $s630 = "include" fullword ascii
        $s631 = "initterm_0" fullword ascii
        $s632 = "lParam" fullword ascii
        $s633 = "left" fullword ascii
        $s634 = "load" fullword ascii
        $s635 = "lpAppName" fullword ascii
        $s636 = "lpBuffer" fullword ascii
        $s637 = "lpCmdLine" fullword ascii
        $s638 = "lpCommandLine" fullword ascii
        $s639 = "lpData" fullword ascii
        $s640 = "lpFileName" fullword ascii
        $s641 = "lpName" fullword ascii
        $s642 = "lpPathName" fullword ascii
        $s643 = "lpReserved" fullword ascii
        $s644 = "lpStartupInfo" fullword ascii
        $s645 = "lpString" fullword ascii
        $s646 = "lpThreadParameter" fullword ascii
        $s647 = "lpType" fullword ascii
        $s648 = "lpdwReserved" fullword ascii
        $s649 = "lpsz" fullword ascii
        $s650 = "lpszStart" fullword ascii
        $s651 = "lptstrFilename" fullword ascii
        $s652 = "lstrcmpA" fullword ascii
        $s653 = "matherr" fullword ascii
        $s654 = "memcpy_0" fullword ascii
        $s655 = "memcpy_s" fullword ascii
        $s656 = "memory" fullword ascii
        $s657 = "memset" fullword ascii
        $s658 = "memset_0" fullword ascii
        $s659 = "message" fullword ascii
        $s660 = "mips" fullword ascii
        $s661 = "msdownld" fullword ascii
        $s662 = "nNumberOfBytesToWrite" fullword ascii
        $s663 = "nShowCmd" fullword ascii
        $s664 = "newmode" fullword ascii
        $s665 = "off_140009000" fullword ascii
        $s666 = "oflag" fullword ascii
        $s667 = "openfunc" fullword ascii
        $s668 = "output" fullword ascii
        $s669 = "pHandles" fullword ascii
        $s670 = "pIdentifierAuthority" fullword ascii
        $s671 = "pSid" fullword ascii
        $s672 = "pSid2" fullword ascii
        $s673 = "perf" fullword ascii
        $s674 = "pfdici" fullword ascii
        $s675 = "pfdin" fullword ascii
        $s676 = "pmode" fullword ascii
        $s677 = "pre_c_init" fullword ascii
        $s678 = "pre_cpp_init" fullword ascii
        $s679 = "pszCabPath" fullword ascii
        $s680 = "pszCabinet" fullword ascii
        $s681 = "pszDest" fullword ascii
        $s682 = "pszDesta" fullword ascii
        $s683 = "pszFile" fullword ascii
        $s684 = "pszFormat" fullword ascii
        $s685 = "pszSrc" fullword ascii
        $s686 = "puLen" fullword ascii
        $s687 = "qword_14000C260" fullword ascii
        $s688 = "qword_14000D058" fullword ascii
        $s689 = "r10d" fullword ascii
        $s690 = "r11d" fullword ascii
        $s691 = "r12d" fullword ascii
        $s692 = "r13d" fullword ascii
        $s693 = "r14d" fullword ascii
        $s694 = "r15d" fullword ascii
        $s695 = "readfunc" fullword ascii
        $s696 = "resource" fullword ascii
        $s697 = "result" fullword ascii
        $s698 = "retstr" fullword ascii
        $s699 = "return" fullword ascii
        $s700 = "right" fullword ascii
        $s701 = "rsize_t" fullword ascii
        $s702 = "rundll32" fullword ascii
        $s703 = "sadvpack" fullword ascii
        $s704 = "seekfunc" fullword ascii
        $s705 = "seektype" fullword ascii
        $s706 = "setupapi" fullword ascii
        $s707 = "setupx" fullword ascii
        $s708 = "signed" fullword ascii
        $s709 = "size_t" fullword ascii
        $s710 = "sizeof" fullword ascii
        $s711 = "strcpy" fullword ascii
        $s712 = "string" fullword ascii
        $s713 = "struct" fullword ascii
        $s714 = "switch" fullword ascii
        $s715 = "tagMSG" fullword ascii
        $s716 = "tagRECT" fullword ascii
        $s717 = "terminate" fullword ascii
        $s718 = "thunk" fullword ascii
        $s719 = "uType" fullword ascii
        $s720 = "uintptr_t" fullword ascii
        $s721 = "unk_14000C228" fullword ascii
        $s722 = "unk_14000C230" fullword ascii
        $s723 = "unk_14000C238" fullword ascii
        $s724 = "unk_14000C270" fullword ascii
        $s725 = "unk_14000C278" fullword ascii
        $s726 = "unk_14000C280" fullword ascii
        $s727 = "unk_14000D83C" fullword ascii
        $s728 = "unk_14000DB4C" fullword ascii
        $s729 = "unk_14000DC50" fullword ascii
        $s730 = "unk_14000DD54" fullword ascii
        $s731 = "unsigned" fullword ascii
        $s732 = "va_list" fullword ascii
        $s733 = "va_start" fullword ascii
        $s734 = "void" fullword ascii
        $s735 = "wLanguage" fullword ascii
        $s736 = "wParam" fullword ascii
        $s737 = "wProcessorArchitecture" fullword ascii
        $s738 = "wShowWindow" fullword ascii
        $s739 = "wextract_cleanup" fullword ascii
        $s740 = "while" fullword ascii
        $s741 = "wininit" fullword ascii
        $s742 = "word_14000CD18" fullword ascii
        $s743 = "word_14000DE58" fullword ascii
        $s744 = "word_14000DE5A" fullword ascii
        $s745 = "write" fullword ascii
        $s746 = "writefunc" fullword ascii
        $s747 = "wrong" fullword ascii
        $s748 = "xmm0" fullword ascii
        $s749 = "xmm1" fullword ascii

    condition:
        uint16(0) == 0x5A4D and 750 of them
}