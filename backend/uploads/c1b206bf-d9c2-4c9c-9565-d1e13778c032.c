#include "c1b206bf-d9c2-4c9c-9565-d1e13778c032.h"
...
_DWORD *__fastcall sub_62742CD0(_DWORD *a1, int a2, const char *a3, int a4, DWORD *a5)
{
  ...
  CY Data[2]; // [rsp+1A0h] [rbp-488h] BYREF
  ...
  if ( !RegOpenKeyExW(HKEY_LOCAL_MACHINE, v7, 0, 0x108u, (PHKEY)&hKey) )
  {
    ...
    for ( i = 0; ; ++i )
    {
      ...
      if ( !RegOpenKeyExW((HKEY)hKey, Name, 0, 0x101u, (PHKEY)&phkResult) )
      {
        ...
        {
          *((_BYTE *)&Data[0].Lo + cbData) = 0;
          *((_BYTE *)&Data[0].Lo + cbData + 1) = 0;
          break;
        }
  ...
  *(_QWORD *)&lpMem.vt = 0;
  ...
  if ( v2 )
  {
    ...
    else
    {
      ...
      {
        v6 = wcslen(String);
        if ( !wcsncmp(*(const wchar_t **)(*(_QWORD *)&lpMem.vt + v5), String, v6) )
        {
          v3 = 1;
          goto LABEL_7;
        }
