#include "73261884-c03a-40ca-b6ba-01e69251e868.h"
...
LABEL_25:
    ...
    do
    {
      if ( v26 == -2147483386 )
        break;
      v28 = *((_BYTE *)v27 + &lpPathName - (CHAR *)FileName);
      if ( !v28 )
        break;
      *(_BYTE *)v27 = v28;
...
unsigned int AddRegRunOnce()
{
  ...
  if ( !result )
  {
    ...
    if ( v0 )
      v11 = aRundll32ExeSad;
    StringCchPrintfA(lpData, v9, v11, Filename, &lpPathName);
    do
      ++v6;
    while ( lpData[v6] );
...
LABEL_6:
  ...
  if ( LibraryA )
  {
    ...
    if ( ProcAddress )
      ((void (__fastcall *)(CHAR *, _QWORD))ProcAddress)(&lpPathName, 0);
  }
  FreeLibrary(v1);
...
LABEL_14:
    ...
    if ( !(unsigned int)IsEnoughSpace((CHAR)v10) )
      return 0;
  }
...
__int64 __fastcall TempDirDlgProc(HWND hDlg, int a2, __int64 a3)
{
  ...
  if ( v4 )
  {
    ...
    if ( GetDlgItemTextA(hDlg, 2101, &lpPathName, 260) )
    {
      v12 = -1;
      do
        ++v12;
      while ( *(&lpPathName + v12) );
      if ( v12 >= 3 && (byte_14000D611 == 58 || lpPathName == 92 && byte_14000D611 == 92) )
      {
        if ( GetFileAttributesA(&lpPathName) != -1 )
          goto LABEL_25;
        ...
        {
LABEL_25:
          AddPath(&lpPathName, 0x104u, pszCabPath);
          if ( (unsigned int)IsGoodTempDir((CHAR)&lpPathName) )
          {
            if ( (lpPathName != 92 || byte_14000D611 != 92) && !(unsigned int)IsEnoughSpace((CHAR)&lpPathName) )
              return 1;
            v11 = 1;
LABEL_30:
            EndDialog(hDlg, v11);
...
}__int64 __fastcall fdiNotifyExtract(_XSAVE_FORMAT *__return_ptr retstr, __int64 fdint, PFDINOTIFICATION pfdin)
{
  ...
  if ( !v6 )
  {
    ...
    do
      ++v15;
    while ( *(&lpPathName + v15) );
    if ( (int)v15 + (int)v14 + 1 >= 260 || !(unsigned int)CatDirAndFile(FileName, &lpPathName, v13) )
      return -1;
  ...
  do
    ++v10;
  while ( *(&lpPathName + v10) );
  if ( (int)v10 + (int)v9 + 1 >= 260 )
    return -1;
  if ( !(unsigned int)CatDirAndFile(FileName, &lpPathName, v8) )
    return -1;
...
LSTATUS DeleteExtractedFiles()
{
  ...
  SIZE_T szStart[34]; // [rsp+40h] [rbp-128h] BYREF
  ...
  if ( g_CMD && !dword_14000CD04 && !dword_14000DE60 )
  {
    ...
    do
    {
      if ( v4 == -2147483386 )
        break;
      v6 = *((_BYTE *)v5 + &lpPathName - (CHAR *)szStart);
      if ( !v6 )
        break;
      *(_BYTE *)v5 = v6;
      v5 = (SIZE_T *)((char *)v5 + 1);
    ...
    *(_BYTE *)v7 = 0;
    ...
    DeleteMyDir((const CHAR *)szStart);
    result = g_CMD;
  }
  if ( g_wOSVer != 1 )
  {
...
LABEL_30:
  if ( a3 && !(unsigned int)IsEnoughSpace((CHAR)&lpPathName) )
  {
    if ( g_CMD )
    {
      g_CMD = 0;
...
__int64 GetTempDirectory()
{
  ...
  if ( !dword_14000CD04 && !dword_14000DE60 )
  {
    if ( GetTempPathA(0x104u, &lpPathName)
      && ((unsigned int)CreateAndValidateSubdir(&lpPathName, 1, 3)
       || !(unsigned int)IsWindowsDrive(&lpPathName) && (unsigned int)CreateAndValidateSubdir(&lpPathName, 1, 1)) )
    {
      return 1;
    }
    while ( 1 )
...
LABEL_56:
      ...
      if ( !(unsigned int)IsEnoughSpace((CHAR)RootPathName) )
        return 0;
    }
    while ( 1 )
    {
      ...
      if ( !(unsigned int)IsEnoughSpace((CHAR)RootPathName)
        && ((unsigned int)IsWindowsDrive(RootPathName) || !(unsigned int)IsEnoughSpace((CHAR)RootPathName)) )
      {
        break;
      }
      ...
      if ( DirectoryA )
      {
        ...
        do
        {
          if ( v19 == -2147483386 )
            break;
          v21 = v20[RootPathName - &lpPathName];
          if ( !v21 )
            break;
          *v20++ = v21;
          --v19;
        ...
        if ( v19 )
          v22 = v20;
        *v22 = 0;
        if ( (unsigned int)CreateAndValidateSubdir(&lpPathName, 1, 0) )
          return 1;
        v16 = RootPathName[0];
      }
      else
...
__int64 __fastcall IsGoodTempDir(const char *lpFileName)
{
  __int64 v2; // rbx
  unsigned int v3; // ebx
  char *v4; // rax
...
__int64 __fastcall IsEnoughSpace(const CHAR *lpPathName, char a2, int a3)
{
  DWORD v6; // r14d
  unsigned int v7; // esi
  DWORD v8; // eax
  ...
  int NumberOfFreeClusters; // [rsp+50h] [rbp-B8h] BYREF
...
__int64 __fastcall ProcessUpdatedFile_Write(DWORD nNumberOfBytesToWrite, __int64 a2, const char *a3, const void *a4)
{
  ...
  HANDLE FileA; // rax
  void *v12; // rdi
  FILETIME NumberOfBytesWritten; // [rsp+40h] [rbp-148h] BYREF
  CHAR FileName[272]; // [rsp+50h] [rbp-138h] BYREF

  NumberOfBytesWritten.dwLowDateTime = 0;
  v5 = (SIZE_T *)FileName;
  v7 = 1;
  v8 = 260;
  do
  {
    if ( v8 == -2147483386 )
      break;
    v9 = *((_BYTE *)v5 + &lpPathName - FileName);
    if ( !v9 )
      break;
    *(_BYTE *)v5 = v9;
    v5 = (SIZE_T *)((char *)v5 + 1);
  ...
  *(_BYTE *)v10 = 0;
  ...
  {
    if ( !WriteFile(FileA, a4, nNumberOfBytesToWrite, (LPDWORD)&NumberOfBytesWritten, 0)
      || nNumberOfBytesToWrite != NumberOfBytesWritten.dwLowDateTime )
    {
      g_dwExitCode = -2147024814;
      v7 = 0;
    }
...
HMODULE MyLoadLibrary()
{
  ...
  do
  {
    if ( v0 == -2147483386 )
      break;
    v2 = *((_BYTE *)v1 + &lpPathName - FileName);
    if ( !v2 )
      break;
    *(_BYTE *)v1 = v2;
    v1 = (SIZE_T *)((char *)v1 + 1);
...
__int64 RunningOnWin95BiDiLoc()
{
  ...
  if ( dword_14000C20C == -2 )
  {
    ...
    if ( RegOpenKeyExA(HKEY_CURRENT_USER, "Control Panel\\Desktop\\ResourceLocale", 0, 0x20019u, &hKey) )
      return (unsigned int)dword_14000C20C;
    v2 = RegQueryValueExA(hKey, pszCabPath, 0, Type, Data, &cbData);
    RegCloseKey(hKey);
    if ( v2 )
      return (unsigned int)dword_14000C20C;
...
}__int64 pre_cpp_init()
{
  ...
  result = __getmainargs(0x14000C228LL, 0x14000C230LL, 0x14000C238LL, (unsigned int)dowildcard, 0x14000C244LL);
...
void __cdecl  _report_gsfailure(uintptr_t StackCookie)
{
  ...
  ULONG64 ControlPc; // [rsp+48h] [rbp-40h]
...
_LUID __fastcall __CxxUnhandledExceptionFilter(struct _EXCEPTION_POINTERS *ExceptionInfo)
{
