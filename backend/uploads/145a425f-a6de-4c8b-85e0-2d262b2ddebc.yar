rule AutoGen_ff90a340 : Malware {
    ...
    strings:
        ...
        $s522 = "a6de" fullword ascii
        $s523 = "aCommandComCS" fullword ascii
        $s524 = "aDefaultinstall" fullword ascii
        $s525 = "aDoinfinstall" fullword ascii
        $s526 = "aRundll32ExeSad" fullword ascii
        $s527 = "aSDS" fullword ascii
        $s528 = "aShbrowseforfol" fullword ascii
        $s529 = "aShgetpathfromi" fullword ascii
        $s530 = "aSystemCurrentc" fullword ascii
        $s531 = "aSystemCurrentc_0" fullword ascii
        $s532 = "advapi32" fullword ascii
        $s533 = "advpack" fullword ascii
        ...
        $s554 = "check_managed_app" fullword ascii
        $s555 = "closefunc" fullword ascii
        $s556 = "const" fullword ascii
        $s557 = "continue" fullword ascii
        $s558 = "date" fullword ascii
        $s559 = "default" fullword ascii
        $s560 = "detected" fullword ascii
        $s561 = "dist" fullword ascii
        $s562 = "dwBuildNumber" fullword ascii
        $s563 = "dwDisposition" fullword ascii
        $s564 = "dwFileAttributes" fullword ascii
        $s565 = "dwFlags" fullword ascii
        $s566 = "dwHandle" fullword ascii
        $s567 = "dwInitParam" fullword ascii
        $s568 = "dwLen" fullword ascii
        $s569 = "dwMajorVersion" fullword ascii
        $s570 = "dwMinorVersion" fullword ascii
        $s571 = "dwOSVersionInfoSize" fullword ascii
        $s572 = "dwPlatformId" fullword ascii
        $s573 = "dwReserved" fullword ascii
        $s574 = "dword_408128" fullword ascii
        $s575 = "dword_4081D4" fullword ascii
        $s576 = "dword_4081D8" fullword ascii
        $s577 = "dword_4081E0" fullword ascii
        $s578 = "dword_4081E4" fullword ascii
        $s579 = "dword_4081E8" fullword ascii
        $s580 = "dword_4081F4" fullword ascii
        $s581 = "dword_4081F8" fullword ascii
        $s582 = "dword_4081FC" fullword ascii
        $s583 = "dword_408200" fullword ascii
        $s584 = "dword_408204" fullword ascii
        $s585 = "dword_40820C" fullword ascii
        $s586 = "dword_408210" fullword ascii
        $s587 = "dword_408214" fullword ascii
        $s588 = "dword_408250" fullword ascii
        $s589 = "dword_4082EC" fullword ascii
        $s590 = "dword_4082F0" fullword ascii
        $s591 = "dword_4082F4" fullword ascii
        $s592 = "dword_4082F8" fullword ascii
        $s593 = "dword_4082FC" fullword ascii
        $s594 = "dword_408300" fullword ascii
        $s595 = "dword_408304" fullword ascii
        $s596 = "dword_408308" fullword ascii
        $s597 = "dword_408310" fullword ascii
        $s598 = "dword_408314" fullword ascii
        $s599 = "dword_408590" fullword ascii
        $s600 = "dword_408A24" fullword ascii
        $s601 = "dword_408A28" fullword ascii
        $s602 = "dword_408A2C" fullword ascii
        $s603 = "dword_408A30" fullword ascii
        $s604 = "dword_408A34" fullword ascii
        $s605 = "dword_408D48" fullword ascii
        $s606 = "dword_408D64" fullword ascii
        $s607 = "dword_408D68" fullword ascii
        $s608 = "dword_408D6C" fullword ascii
        $s609 = "dword_408D70" fullword ascii
        $s610 = "dword_408D74" fullword ascii
        $s611 = "dword_409144" fullword ascii
        $s612 = "dword_4091D8" fullword ascii
        $s613 = "dword_4091DC" fullword ascii
        $s614 = "dword_4093EC" fullword ascii
        $s615 = "dword_4093F4" fullword ascii
        $s616 = "dword_4093F8" fullword ascii
        $s617 = "dword_409400" fullword ascii
        $s618 = "dword_409A2C" fullword ascii
        $s619 = "dword_409A30" fullword ascii
        $s620 = "dword_409A34" fullword ascii
        $s621 = "dword_409A38" fullword ascii
        $s622 = "else" fullword ascii
        $s623 = "erfOper" fullword ascii
        $s624 = "fdiNotifyExtract" fullword ascii
        $s625 = "fdint" fullword ascii
        $s626 = "fdintCABINET_INFO" fullword ascii
        $s627 = "fdintCLOSE_FILE_INFO" fullword ascii
        $s628 = "fdintCOPY_FILE" fullword ascii
        $s629 = "fdintNEXT_CABINET" fullword ascii
        $s630 = "fdintPARTIAL_FILE" fullword ascii
        $s631 = "freefunc" fullword ascii
        $s632 = "g_CMD" fullword ascii
        $s633 = "g_FileTable" fullword ascii
        $s634 = "g_Sess" fullword ascii
        $s635 = "g_bConvertRunOnce" fullword ascii
        $s636 = "g_dwExitCode" fullword ascii
        $s637 = "g_dwFileSizes" fullword ascii
        $s638 = "g_dwRebootCheck" fullword ascii
        $s639 = "g_fOSSupportsFullUI" fullword ascii
        $s640 = "g_fOSSupportsINFInstalls" fullword ascii
        $s641 = "g_hCancelEvent" fullword ascii
        $s642 = "g_hInst" fullword ascii
        $s643 = "g_hMutex" fullword ascii
        $s644 = "g_hwndExtractDlg" fullword ascii
        $s645 = "g_lpfnOldMEditWndProc" fullword ascii
        $s646 = "g_szBrowsePath" fullword ascii
        $s647 = "g_szLicense" fullword ascii
        $s648 = "g_szRegValName" fullword ascii
        $s649 = "g_uInfRebootOn" fullword ascii
        $s650 = "g_wOSVer" fullword ascii
        $s651 = "hDlg" fullword ascii
        $s652 = "hInstance" fullword ascii
        $s653 = "hMem" fullword ascii
        $s654 = "hModule" fullword ascii
        $s655 = "hObject" fullword ascii
        $s656 = "hPrevInstance" fullword ascii
        $s657 = "hProcess" fullword ascii
        $s658 = "hThread" fullword ascii
        $s659 = "hWnd" fullword ascii
        $s660 = "hWndParent" fullword ascii
        $s661 = "hasnext" fullword ascii
        $s662 = "hasprev" fullword ascii
        $s663 = "i386" fullword ascii
        $s664 = "include" fullword ascii
        $s665 = "kr00_4" fullword ascii
        $s666 = "kr04_4" fullword ascii
        $s667 = "lParam" fullword ascii
        $s668 = "left" fullword ascii
        $s669 = "load" fullword ascii
        $s670 = "lpBuffer" fullword ascii
        $s671 = "lpCmdLine" fullword ascii
        $s672 = "lpDialogFunc" fullword ascii
        $s673 = "lpFileName" fullword ascii
        $s674 = "lpName" fullword ascii
        $s675 = "lpPathName" fullword ascii
        $s676 = "lpRootPathName" fullword ascii
        $s677 = "lpStartupInfo" fullword ascii
        $s678 = "lpString" fullword ascii
        $s679 = "lpType" fullword ascii
        $s680 = "lpdwReserved" fullword ascii
        $s681 = "lpsz" fullword ascii
        $s682 = "lpszStart" fullword ascii
        $s683 = "lpsza" fullword ascii
        $s684 = "lptstrFilename" fullword ascii
        $s685 = "lstrcmpA" fullword ascii
        $s686 = "memcpy" fullword ascii
        $s687 = "memset" fullword ascii
        $s688 = "message" fullword ascii
        $s689 = "mips" fullword ascii
        $s690 = "msdownld" fullword ascii
        $s691 = "nNumberOfBytesToWrite" fullword ascii
        $s692 = "nResult" fullword ascii
        $s693 = "nShowCmd" fullword ascii
        $s694 = "off_401000" fullword ascii
        $s695 = "oflag" fullword ascii
        $s696 = "openfunc" fullword ascii
        $s697 = "output" fullword ascii
        $s698 = "pBlock" fullword ascii
        $s699 = "pHandles" fullword ascii
        $s700 = "pIdentifierAuthority" fullword ascii
        $s701 = "pSid" fullword ascii
        $s702 = "pcchNewDestLength" fullword ascii
        $s703 = "perf" fullword ascii
        $s704 = "pfdici" fullword ascii
        $s705 = "pfdin" fullword ascii
        $s706 = "phkResult" fullword ascii
        $s707 = "positive" fullword ascii
        $s708 = "pre_cpp_init" fullword ascii
        $s709 = "psz1" fullword ascii
        $s710 = "pszCabPath" fullword ascii
        $s711 = "pszCabinet" fullword ascii
        $s712 = "pszDest" fullword ascii
        $s713 = "pszDesta" fullword ascii
        $s714 = "pszFile" fullword ascii
        $s715 = "pszFormat" fullword ascii
        $s716 = "pszSrc" fullword ascii
        $s717 = "puLen" fullword ascii
        $s718 = "qmemcpy" fullword ascii
        $s719 = "readfunc" fullword ascii
        $s720 = "resource" fullword ascii
        $s721 = "result" fullword ascii
        $s722 = "retaddr" fullword ascii
        $s723 = "return" fullword ascii
        $s724 = "right" fullword ascii
        $s725 = "rsize_t" fullword ascii
        $s726 = "rundll32" fullword ascii
        $s727 = "sadvpack" fullword ascii
        $s728 = "savAppExitCode" fullword ascii
        $s729 = "seekfunc" fullword ascii
        $s730 = "seektype" fullword ascii
        $s731 = "setupapi" fullword ascii
        $s732 = "setupx" fullword ascii
        $s733 = "signed" fullword ascii
        $s734 = "size_t" fullword ascii
        $s735 = "sizeof" fullword ascii
        $s736 = "strcpy" fullword ascii
        $s737 = "string" fullword ascii
        $s738 = "strlen" fullword ascii
        $s739 = "struct" fullword ascii
        $s740 = "switch" fullword ascii
        $s741 = "szCSDVersion" fullword ascii
        $s742 = "tagMSG" fullword ascii
        $s743 = "tagRECT" fullword ascii
        $s744 = "terminate" fullword ascii
        $s745 = "this" fullword ascii
        $s746 = "thunk" fullword ascii
        $s747 = "time" fullword ascii
        $s748 = "uType" fullword ascii
        $s749 = "uintptr_t" fullword ascii
        $s750 = "unk_4081EC" fullword ascii
        $s751 = "unk_4081F0" fullword ascii
        $s752 = "unk_408218" fullword ascii
        $s753 = "unk_40821C" fullword ascii
        $s754 = "unk_40940C" fullword ascii
        $s755 = "unk_40971C" fullword ascii
        $s756 = "unsigned" fullword ascii
        $s757 = "unused" fullword ascii
        $s758 = "va_list" fullword ascii
        $s759 = "va_start" fullword ascii
        $s760 = "value" fullword ascii
        $s761 = "vars0" fullword ascii
        $s762 = "void" fullword ascii
        $s763 = "wFatTime" fullword ascii
        $s764 = "wLanguage" fullword ascii
        $s765 = "wParam" fullword ascii
        $s766 = "wProcessorArchitecture" fullword ascii
        $s767 = "wShowWindow" fullword ascii
        $s768 = "wextract_cleanup" fullword ascii
        $s769 = "while" fullword ascii
        $s770 = "wininit" fullword ascii
        $s771 = "word_4082DC" fullword ascii
        $s772 = "word_4082E0" fullword ascii
        $s773 = "word_4082E4" fullword ascii
        $s774 = "word_4082E8" fullword ascii
        $s775 = "word_40830C" fullword ascii
        $s776 = "word_408318" fullword ascii
        $s777 = "word_408A38" fullword ascii
        $s778 = "word_409A28" fullword ascii
        $s779 = "word_409A2A" fullword ascii
        $s780 = "writefunc" fullword ascii
        $s781 = "wrong" fullword ascii

    condition:
        uint16(0) == 0x5A4D and 782 of them
}