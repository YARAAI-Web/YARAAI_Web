rule AutoGen_5a75d087 : Malware {
    ...
    strings:
        ...
        $s531 = "been" fullword ascii
        $s532 = "bool" fullword ascii
        $s533 = "bottom" fullword ascii
        $s534 = "break" fullword ascii
        $s535 = "byte_14000CD1A" fullword ascii
        $s536 = "byte_14000CE1F" fullword ascii
        $s537 = "byte_14000CF22" fullword ascii
        $s538 = "byte_14000D611" fullword ascii
        $s539 = "cFileName" fullword ascii
        $s540 = "case" fullword ascii
        $s541 = "cbData" fullword ascii
        $s542 = "cchDest" fullword ascii
        $s543 = "cf068af7f245" fullword ascii
        $s544 = "closefunc" fullword ascii
        $s545 = "const" fullword ascii
        $s546 = "continue" fullword ascii
        $s547 = "d12708df" fullword ascii
        $s548 = "d153" fullword ascii
        $s549 = "default" fullword ascii
        $s550 = "detected" fullword ascii
        $s551 = "dist" fullword ascii
        $s552 = "dowildcard" fullword ascii
        $s553 = "dwCreationDisposition" fullword ascii
        $s554 = "dwDisposition" fullword ascii
        $s555 = "dwFileAttributes" fullword ascii
        $s556 = "dwFlags" fullword ascii
        $s557 = "dwHandle" fullword ascii
        $s558 = "dwInitParam" fullword ascii
        $s559 = "dwLowDateTime" fullword ascii
        $s560 = "dwMajorVersion" fullword ascii
        $s561 = "dwMinorVersion" fullword ascii
        $s562 = "dwOSVersionInfoSize" fullword ascii
        $s563 = "dwPlatformId" fullword ascii
        $s564 = "dwReserved" fullword ascii
        $s565 = "dword_14000C14C" fullword ascii
        $s566 = "dword_14000C208" fullword ascii
        $s567 = "dword_14000C20C" fullword ascii
        $s568 = "dword_14000C220" fullword ascii
        $s569 = "dword_14000C224" fullword ascii
        $s570 = "dword_14000C22C" fullword ascii
        $s571 = "dword_14000C240" fullword ascii
        $s572 = "dword_14000C244" fullword ascii
        $s573 = "dword_14000C250" fullword ascii
        $s574 = "dword_14000C254" fullword ascii
        $s575 = "dword_14000C268" fullword ascii
        $s576 = "dword_14000C840" fullword ascii
        $s577 = "dword_14000CCE0" fullword ascii
        $s578 = "dword_14000CD04" fullword ascii
        $s579 = "dword_14000CD08" fullword ascii
        $s580 = "dword_14000CD0C" fullword ascii
        $s581 = "dword_14000CD10" fullword ascii
        $s582 = "dword_14000CD14" fullword ascii
        $s583 = "dword_14000D028" fullword ascii
        $s584 = "dword_14000D568" fullword ascii
        $s585 = "dword_14000D5FC" fullword ascii
        $s586 = "dword_14000D600" fullword ascii
        $s587 = "dword_14000D818" fullword ascii
        $s588 = "dword_14000D820" fullword ascii
        $s589 = "dword_14000D824" fullword ascii
        $s590 = "dword_14000D82C" fullword ascii
        $s591 = "dword_14000DE5C" fullword ascii
        $s592 = "dword_14000DE60" fullword ascii
        $s593 = "dword_14000DE64" fullword ascii
        $s594 = "dword_14000DE68" fullword ascii
        $s595 = "else" fullword ascii
        $s596 = "erfOper" fullword ascii
        $s597 = "exit" fullword ascii
        $s598 = "fdiNotifyExtract" fullword ascii
        $s599 = "fdint" fullword ascii
        $s600 = "freefunc" fullword ascii
        $s601 = "g_CMD" fullword ascii
        $s602 = "g_FileTable" fullword ascii
        $s603 = "g_Sess" fullword ascii
        $s604 = "g_bConvertRunOnce" fullword ascii
        $s605 = "g_dwExitCode" fullword ascii
        $s606 = "g_dwFileSizes" fullword ascii
        $s607 = "g_dwRebootCheck" fullword ascii
        $s608 = "g_fOSSupportsFullUI" fullword ascii
        $s609 = "g_fOSSupportsINFInstalls" fullword ascii
        $s610 = "g_hCancelEvent" fullword ascii
        $s611 = "g_hInst" fullword ascii
        $s612 = "g_hMutex" fullword ascii
        $s613 = "g_hwndExtractDlg" fullword ascii
        $s614 = "g_lpfnOldMEditWndProc" fullword ascii
        $s615 = "g_szBrowsePath" fullword ascii
        $s616 = "g_szLicense" fullword ascii
        $s617 = "g_szRegValName" fullword ascii
        $s618 = "g_uInfRebootOn" fullword ascii
        $s619 = "g_wOSVer" fullword ascii
        $s620 = "get_image_app_type" fullword ascii
        $s621 = "guard_check_icall_nop" fullword ascii
        $s622 = "guard_dispatch_icall_nop" fullword ascii
        $s623 = "hDlg" fullword ascii
        $s624 = "hInstance" fullword ascii
        $s625 = "hKey" fullword ascii
        $s626 = "hMem" fullword ascii
        $s627 = "hModule" fullword ascii
        $s628 = "hPrevInstance" fullword ascii
        $s629 = "hProcess" fullword ascii
        $s630 = "hThread" fullword ascii
        $s631 = "hWnd" fullword ascii
        $s632 = "i386" fullword ascii
        $s633 = "include" fullword ascii
        $s634 = "initterm_0" fullword ascii
        $s635 = "lParam" fullword ascii
        $s636 = "left" fullword ascii
        $s637 = "load" fullword ascii
        $s638 = "lpAppName" fullword ascii
        $s639 = "lpBuffer" fullword ascii
        $s640 = "lpCmdLine" fullword ascii
        $s641 = "lpCommandLine" fullword ascii
        $s642 = "lpData" fullword ascii
        $s643 = "lpFileName" fullword ascii
        $s644 = "lpName" fullword ascii
        $s645 = "lpPathName" fullword ascii
        $s646 = "lpReserved" fullword ascii
        $s647 = "lpStartupInfo" fullword ascii
        $s648 = "lpString" fullword ascii
        $s649 = "lpThreadParameter" fullword ascii
        $s650 = "lpType" fullword ascii
        $s651 = "lpdwReserved" fullword ascii
        $s652 = "lpsz" fullword ascii
        $s653 = "lpszStart" fullword ascii
        $s654 = "lptstrFilename" fullword ascii
        $s655 = "lstrcmpA" fullword ascii
        $s656 = "matherr" fullword ascii
        $s657 = "memcpy_0" fullword ascii
        $s658 = "memcpy_s" fullword ascii
        $s659 = "memory" fullword ascii
        $s660 = "memset" fullword ascii
        $s661 = "memset_0" fullword ascii
        $s662 = "message" fullword ascii
        $s663 = "mips" fullword ascii
        $s664 = "msdownld" fullword ascii
        $s665 = "nNumberOfBytesToWrite" fullword ascii
        $s666 = "nShowCmd" fullword ascii
        $s667 = "newmode" fullword ascii
        $s668 = "off_140009000" fullword ascii
        $s669 = "oflag" fullword ascii
        $s670 = "openfunc" fullword ascii
        $s671 = "output" fullword ascii
        $s672 = "pHandles" fullword ascii
        $s673 = "pIdentifierAuthority" fullword ascii
        $s674 = "pSid" fullword ascii
        $s675 = "pSid2" fullword ascii
        $s676 = "perf" fullword ascii
        $s677 = "pfdici" fullword ascii
        $s678 = "pfdin" fullword ascii
        $s679 = "pmode" fullword ascii
        $s680 = "pre_c_init" fullword ascii
        $s681 = "pre_cpp_init" fullword ascii
        $s682 = "pszCabPath" fullword ascii
        $s683 = "pszCabinet" fullword ascii
        $s684 = "pszDest" fullword ascii
        $s685 = "pszDesta" fullword ascii
        $s686 = "pszFile" fullword ascii
        $s687 = "pszFormat" fullword ascii
        $s688 = "pszSrc" fullword ascii
        $s689 = "puLen" fullword ascii
        $s690 = "qword_14000C260" fullword ascii
        $s691 = "qword_14000D058" fullword ascii
        $s692 = "r10d" fullword ascii
        $s693 = "r11d" fullword ascii
        $s694 = "r12d" fullword ascii
        $s695 = "r13d" fullword ascii
        $s696 = "r14d" fullword ascii
        $s697 = "r15d" fullword ascii
        $s698 = "readfunc" fullword ascii
        $s699 = "resource" fullword ascii
        $s700 = "result" fullword ascii
        $s701 = "retstr" fullword ascii
        $s702 = "return" fullword ascii
        $s703 = "right" fullword ascii
        $s704 = "rsize_t" fullword ascii
        $s705 = "rundll32" fullword ascii
        $s706 = "sadvpack" fullword ascii
        $s707 = "seekfunc" fullword ascii
        $s708 = "seektype" fullword ascii
        $s709 = "setupapi" fullword ascii
        $s710 = "setupx" fullword ascii
        $s711 = "signed" fullword ascii
        $s712 = "size_t" fullword ascii
        $s713 = "sizeof" fullword ascii
        $s714 = "strcpy" fullword ascii
        $s715 = "string" fullword ascii
        $s716 = "struct" fullword ascii
        $s717 = "switch" fullword ascii
        $s718 = "tagMSG" fullword ascii
        $s719 = "tagRECT" fullword ascii
        $s720 = "terminate" fullword ascii
        $s721 = "thunk" fullword ascii
        $s722 = "uType" fullword ascii
        $s723 = "uintptr_t" fullword ascii
        $s724 = "unk_14000C228" fullword ascii
        $s725 = "unk_14000C230" fullword ascii
        $s726 = "unk_14000C238" fullword ascii
        $s727 = "unk_14000C270" fullword ascii
        $s728 = "unk_14000C278" fullword ascii
        $s729 = "unk_14000C280" fullword ascii
        $s730 = "unk_14000D83C" fullword ascii
        $s731 = "unk_14000DB4C" fullword ascii
        $s732 = "unk_14000DC50" fullword ascii
        $s733 = "unk_14000DD54" fullword ascii
        $s734 = "unsigned" fullword ascii
        $s735 = "va_list" fullword ascii
        $s736 = "va_start" fullword ascii
        $s737 = "void" fullword ascii
        $s738 = "wLanguage" fullword ascii
        $s739 = "wParam" fullword ascii
        $s740 = "wProcessorArchitecture" fullword ascii
        $s741 = "wShowWindow" fullword ascii
        $s742 = "wextract_cleanup" fullword ascii
        $s743 = "while" fullword ascii
        $s744 = "wininit" fullword ascii
        $s745 = "word_14000CD18" fullword ascii
        $s746 = "word_14000DE58" fullword ascii
        $s747 = "word_14000DE5A" fullword ascii
        $s748 = "write" fullword ascii
        $s749 = "writefunc" fullword ascii
        $s750 = "wrong" fullword ascii
        $s751 = "xmm0" fullword ascii
        $s752 = "xmm1" fullword ascii

    condition:
        uint16(0) == 0x5A4D and 753 of them
}