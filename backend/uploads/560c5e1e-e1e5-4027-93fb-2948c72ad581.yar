rule AutoGen_5a75d087 : Malware {
    ...
    strings:
        ...
        $s543 = "closefunc" fullword ascii
        $s544 = "const" fullword ascii
        $s545 = "continue" fullword ascii
        $s546 = "default" fullword ascii
        $s547 = "detected" fullword ascii
        $s548 = "dist" fullword ascii
        $s549 = "dowildcard" fullword ascii
        $s550 = "dwCreationDisposition" fullword ascii
        $s551 = "dwDisposition" fullword ascii
        $s552 = "dwFileAttributes" fullword ascii
        $s553 = "dwFlags" fullword ascii
        $s554 = "dwHandle" fullword ascii
        $s555 = "dwInitParam" fullword ascii
        $s556 = "dwLowDateTime" fullword ascii
        $s557 = "dwMajorVersion" fullword ascii
        $s558 = "dwMinorVersion" fullword ascii
        $s559 = "dwOSVersionInfoSize" fullword ascii
        $s560 = "dwPlatformId" fullword ascii
        $s561 = "dwReserved" fullword ascii
        $s562 = "dword_14000C14C" fullword ascii
        $s563 = "dword_14000C208" fullword ascii
        $s564 = "dword_14000C20C" fullword ascii
        $s565 = "dword_14000C220" fullword ascii
        $s566 = "dword_14000C224" fullword ascii
        $s567 = "dword_14000C22C" fullword ascii
        $s568 = "dword_14000C240" fullword ascii
        $s569 = "dword_14000C244" fullword ascii
        $s570 = "dword_14000C250" fullword ascii
        $s571 = "dword_14000C254" fullword ascii
        $s572 = "dword_14000C268" fullword ascii
        $s573 = "dword_14000C840" fullword ascii
        $s574 = "dword_14000CCE0" fullword ascii
        $s575 = "dword_14000CD04" fullword ascii
        $s576 = "dword_14000CD08" fullword ascii
        $s577 = "dword_14000CD0C" fullword ascii
        $s578 = "dword_14000CD10" fullword ascii
        $s579 = "dword_14000CD14" fullword ascii
        $s580 = "dword_14000D028" fullword ascii
        $s581 = "dword_14000D568" fullword ascii
        $s582 = "dword_14000D5FC" fullword ascii
        $s583 = "dword_14000D600" fullword ascii
        $s584 = "dword_14000D818" fullword ascii
        $s585 = "dword_14000D820" fullword ascii
        $s586 = "dword_14000D824" fullword ascii
        $s587 = "dword_14000D82C" fullword ascii
        $s588 = "dword_14000DE5C" fullword ascii
        $s589 = "dword_14000DE60" fullword ascii
        $s590 = "dword_14000DE64" fullword ascii
        $s591 = "dword_14000DE68" fullword ascii
        $s592 = "e1e5" fullword ascii
        $s593 = "else" fullword ascii
        $s594 = "erfOper" fullword ascii
        $s595 = "exit" fullword ascii
        $s596 = "fdiNotifyExtract" fullword ascii
        $s597 = "fdint" fullword ascii
        $s598 = "freefunc" fullword ascii
        $s599 = "g_CMD" fullword ascii
        $s600 = "g_FileTable" fullword ascii
        $s601 = "g_Sess" fullword ascii
        $s602 = "g_bConvertRunOnce" fullword ascii
        $s603 = "g_dwExitCode" fullword ascii
        $s604 = "g_dwFileSizes" fullword ascii
        $s605 = "g_dwRebootCheck" fullword ascii
        $s606 = "g_fOSSupportsFullUI" fullword ascii
        $s607 = "g_fOSSupportsINFInstalls" fullword ascii
        $s608 = "g_hCancelEvent" fullword ascii
        $s609 = "g_hInst" fullword ascii
        $s610 = "g_hMutex" fullword ascii
        $s611 = "g_hwndExtractDlg" fullword ascii
        $s612 = "g_lpfnOldMEditWndProc" fullword ascii
        $s613 = "g_szBrowsePath" fullword ascii
        $s614 = "g_szLicense" fullword ascii
        $s615 = "g_szRegValName" fullword ascii
        $s616 = "g_uInfRebootOn" fullword ascii
        $s617 = "g_wOSVer" fullword ascii
        $s618 = "get_image_app_type" fullword ascii
        $s619 = "guard_check_icall_nop" fullword ascii
        $s620 = "guard_dispatch_icall_nop" fullword ascii
        $s621 = "hDlg" fullword ascii
        $s622 = "hInstance" fullword ascii
        $s623 = "hKey" fullword ascii
        $s624 = "hMem" fullword ascii
        $s625 = "hModule" fullword ascii
        $s626 = "hPrevInstance" fullword ascii
        $s627 = "hProcess" fullword ascii
        $s628 = "hThread" fullword ascii
        $s629 = "hWnd" fullword ascii
        $s630 = "i386" fullword ascii
        $s631 = "include" fullword ascii
        $s632 = "initterm_0" fullword ascii
        $s633 = "lParam" fullword ascii
        $s634 = "left" fullword ascii
        $s635 = "load" fullword ascii
        $s636 = "lpAppName" fullword ascii
        $s637 = "lpBuffer" fullword ascii
        $s638 = "lpCmdLine" fullword ascii
        $s639 = "lpCommandLine" fullword ascii
        $s640 = "lpData" fullword ascii
        $s641 = "lpFileName" fullword ascii
        $s642 = "lpName" fullword ascii
        $s643 = "lpPathName" fullword ascii
        $s644 = "lpReserved" fullword ascii
        $s645 = "lpStartupInfo" fullword ascii
        $s646 = "lpString" fullword ascii
        $s647 = "lpThreadParameter" fullword ascii
        $s648 = "lpType" fullword ascii
        $s649 = "lpdwReserved" fullword ascii
        $s650 = "lpsz" fullword ascii
        $s651 = "lpszStart" fullword ascii
        $s652 = "lptstrFilename" fullword ascii
        $s653 = "lstrcmpA" fullword ascii
        $s654 = "matherr" fullword ascii
        $s655 = "memcpy_0" fullword ascii
        $s656 = "memcpy_s" fullword ascii
        $s657 = "memory" fullword ascii
        $s658 = "memset" fullword ascii
        $s659 = "memset_0" fullword ascii
        $s660 = "message" fullword ascii
        $s661 = "mips" fullword ascii
        $s662 = "msdownld" fullword ascii
        $s663 = "nNumberOfBytesToWrite" fullword ascii
        $s664 = "nShowCmd" fullword ascii
        $s665 = "newmode" fullword ascii
        $s666 = "off_140009000" fullword ascii
        $s667 = "oflag" fullword ascii
        $s668 = "openfunc" fullword ascii
        $s669 = "output" fullword ascii
        $s670 = "pHandles" fullword ascii
        $s671 = "pIdentifierAuthority" fullword ascii
        $s672 = "pSid" fullword ascii
        $s673 = "pSid2" fullword ascii
        $s674 = "perf" fullword ascii
        $s675 = "pfdici" fullword ascii
        $s676 = "pfdin" fullword ascii
        $s677 = "pmode" fullword ascii
        $s678 = "pre_c_init" fullword ascii
        $s679 = "pre_cpp_init" fullword ascii
        $s680 = "pszCabPath" fullword ascii
        $s681 = "pszCabinet" fullword ascii
        $s682 = "pszDest" fullword ascii
        $s683 = "pszDesta" fullword ascii
        $s684 = "pszFile" fullword ascii
        $s685 = "pszFormat" fullword ascii
        $s686 = "pszSrc" fullword ascii
        $s687 = "puLen" fullword ascii
        $s688 = "qword_14000C260" fullword ascii
        $s689 = "qword_14000D058" fullword ascii
        $s690 = "r10d" fullword ascii
        $s691 = "r11d" fullword ascii
        $s692 = "r12d" fullword ascii
        $s693 = "r13d" fullword ascii
        $s694 = "r14d" fullword ascii
        $s695 = "r15d" fullword ascii
        $s696 = "readfunc" fullword ascii
        $s697 = "resource" fullword ascii
        $s698 = "result" fullword ascii
        $s699 = "retstr" fullword ascii
        $s700 = "return" fullword ascii
        $s701 = "right" fullword ascii
        $s702 = "rsize_t" fullword ascii
        $s703 = "rundll32" fullword ascii
        $s704 = "sadvpack" fullword ascii
        $s705 = "seekfunc" fullword ascii
        $s706 = "seektype" fullword ascii
        $s707 = "setupapi" fullword ascii
        $s708 = "setupx" fullword ascii
        $s709 = "signed" fullword ascii
        $s710 = "size_t" fullword ascii
        $s711 = "sizeof" fullword ascii
        $s712 = "strcpy" fullword ascii
        $s713 = "string" fullword ascii
        $s714 = "struct" fullword ascii
        $s715 = "switch" fullword ascii
        $s716 = "tagMSG" fullword ascii
        $s717 = "tagRECT" fullword ascii
        $s718 = "terminate" fullword ascii
        $s719 = "thunk" fullword ascii
        $s720 = "uType" fullword ascii
        $s721 = "uintptr_t" fullword ascii
        $s722 = "unk_14000C228" fullword ascii
        $s723 = "unk_14000C230" fullword ascii
        $s724 = "unk_14000C238" fullword ascii
        $s725 = "unk_14000C270" fullword ascii
        $s726 = "unk_14000C278" fullword ascii
        $s727 = "unk_14000C280" fullword ascii
        $s728 = "unk_14000D83C" fullword ascii
        $s729 = "unk_14000DB4C" fullword ascii
        $s730 = "unk_14000DC50" fullword ascii
        $s731 = "unk_14000DD54" fullword ascii
        $s732 = "unsigned" fullword ascii
        $s733 = "va_list" fullword ascii
        $s734 = "va_start" fullword ascii
        $s735 = "void" fullword ascii
        $s736 = "wLanguage" fullword ascii
        $s737 = "wParam" fullword ascii
        $s738 = "wProcessorArchitecture" fullword ascii
        $s739 = "wShowWindow" fullword ascii
        $s740 = "wextract_cleanup" fullword ascii
        $s741 = "while" fullword ascii
        $s742 = "wininit" fullword ascii
        $s743 = "word_14000CD18" fullword ascii
        $s744 = "word_14000DE58" fullword ascii
        $s745 = "word_14000DE5A" fullword ascii
        $s746 = "write" fullword ascii
        $s747 = "writefunc" fullword ascii
        $s748 = "wrong" fullword ascii
        $s749 = "xmm0" fullword ascii
        $s750 = "xmm1" fullword ascii

    condition:
        uint16(0) == 0x5A4D and 751 of them
}