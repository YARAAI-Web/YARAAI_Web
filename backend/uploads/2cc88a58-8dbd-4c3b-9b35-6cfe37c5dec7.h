...
signed int __usercall sub_429CA8@<eax>(int a1@<eax>, volatile signed __int8 **a2@<ecx>);
DWORD __usercall sub_429D20@<eax>(int a1@<eax>, volatile signed __int8 **a2@<ecx>);
...
int __userpurge sub_42AC6C@<eax>(int a1@<eax>, int a2);
...
_DWORD *__usercall sub_4B8BDC@<eax>(int a1@<ebx>, int a2@<edi>, int a3@<esi>, int a4);
...
_DWORD *__usercall sub_4B9B0C@<eax>(int a1@<ecx>, int a2@<ebx>, int a3@<edi>, int a4@<esi>, int a5);
int __cdecl sub_4B9B7C(int a1);
OLECHAR ***__usercall sub_4B9BC8@<eax>(int a1@<eax>, int a2@<edi>, int a3);
OLECHAR ***__usercall sub_4B9C80@<eax>(int a1@<eax>, int a2@<ecx>, int a3@<edi>, int a4);
int __usercall sub_4B9CD8@<eax>(__int64 *a1@<eax>, int a2@<edx>, int a3@<ebx>, int a4@<edi>, int a5@<esi>);
