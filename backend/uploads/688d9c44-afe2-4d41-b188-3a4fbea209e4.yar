rule AutoGen_ff90a340 : Malware {
    ...
    strings:
        ...
        $s539 = "b188" fullword ascii
        $s540 = "been" fullword ascii
        $s541 = "bool" fullword ascii
        $s542 = "bottom" fullword ascii
        $s543 = "break" fullword ascii
        $s544 = "byte_408A3A" fullword ascii
        $s545 = "byte_408B3F" fullword ascii
        $s546 = "byte_408C42" fullword ascii
        $s547 = "byte_4091E5" fullword ascii
